...
HX_DEFINE_STACK_FRAME(_hx_pos_06bb1fd7fcf4dcd5_476_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","E:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",476,0x60167fc1)
HX_LOCAL_STACK_FRAME(_hx_pos_06bb1fd7fcf4dcd5_477_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","E:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",477,0x60167fc1)
HX_LOCAL_STACK_FRAME(_hx_pos_06bb1fd7fcf4dcd5_478_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","E:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",478,0x60167fc1)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_06bb1fd7fcf4dcd5_476_new)
            	}
...
hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_06bb1fd7fcf4dcd5_477_resolveClass)
...
hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_06bb1fd7fcf4dcd5_478_resolveEnum)

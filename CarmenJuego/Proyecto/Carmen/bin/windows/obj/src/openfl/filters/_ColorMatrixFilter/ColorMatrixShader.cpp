...
HXLINE( 209)		::Array< Float > multipliers = this->uMultipliers->value;
HXLINE( 210)		::Array< Float > offsets = this->uOffsets->value;
HXLINE( 212)		multipliers[(int)0] = matrix->__get((int)0);
HXLINE( 213)		multipliers[(int)1] = matrix->__get((int)1);
HXLINE( 214)		multipliers[(int)2] = matrix->__get((int)2);
HXLINE( 215)		multipliers[(int)3] = matrix->__get((int)3);
HXLINE( 216)		multipliers[(int)4] = matrix->__get((int)5);
HXLINE( 217)		multipliers[(int)5] = matrix->__get((int)6);
HXLINE( 218)		multipliers[(int)6] = matrix->__get((int)7);
HXLINE( 219)		multipliers[(int)7] = matrix->__get((int)8);
HXLINE( 220)		multipliers[(int)8] = matrix->__get((int)10);
HXLINE( 221)		multipliers[(int)9] = matrix->__get((int)11);
HXLINE( 222)		multipliers[(int)10] = matrix->__get((int)12);
HXLINE( 223)		multipliers[(int)11] = matrix->__get((int)13);
HXLINE( 224)		multipliers[(int)12] = matrix->__get((int)15);
HXLINE( 225)		multipliers[(int)13] = matrix->__get((int)16);
HXLINE( 226)		multipliers[(int)14] = matrix->__get((int)17);
HXLINE( 227)		multipliers[(int)15] = matrix->__get((int)18);
HXLINE( 229)		offsets[(int)0] = ((Float)matrix->__get((int)4) / (Float)((Float)255.0));
HXLINE( 230)		offsets[(int)1] = ((Float)matrix->__get((int)9) / (Float)((Float)255.0));
HXLINE( 231)		offsets[(int)2] = ((Float)matrix->__get((int)14) / (Float)((Float)255.0));
HXLINE( 232)		offsets[(int)3] = ((Float)matrix->__get((int)19) / (Float)((Float)255.0));
            	}

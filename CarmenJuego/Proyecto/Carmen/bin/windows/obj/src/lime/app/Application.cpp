...
HX_DEFINE_STACK_FRAME(_hx_pos_da4fb7bee4c62773_20_new,"lime.app.Application","new",0x9354427c,"lime.app.Application.new","lime/app/Application.hx",20,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_aca430172aa84436_85___init__,"::lime::app::Application_obj","__init__",0x5d7d4402,"::lime::app::Application_obj.__init__","lime/app/Application.hx",85,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_128_addModule,"lime.app.Application","addModule",0x673258c9,"lime.app.Application.addModule","lime/app/Application.hx",128,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_163_addRenderer,"lime.app.Application","addRenderer",0x0a61eaa0,"lime.app.Application.addRenderer","lime/app/Application.hx",163,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_182_create,"lime.app.Application","create",0x35e42e60,"lime.app.Application.create","lime/app/Application.hx",182,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_233_createWindow,"lime.app.Application","createWindow",0xb3683e70,"lime.app.Application.createWindow","lime/app/Application.hx",233,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_265_exec,"lime.app.Application","exec",0x508159f5,"lime.app.Application.exec","lime/app/Application.hx",265,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_276_onModuleExit,"lime.app.Application","onModuleExit",0x4a2a2a4d,"lime.app.Application.onModuleExit","lime/app/Application.hx",276,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_283_onWindowClose,"lime.app.Application","onWindowClose",0x133677e5,"lime.app.Application.onWindowClose","lime/app/Application.hx",283,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_294_removeModule,"lime.app.Application","removeModule",0x6e873a74,"lime.app.Application.removeModule","lime/app/Application.hx",294,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_306_removeWindow,"lime.app.Application","removeWindow",0x004099b8,"lime.app.Application.removeWindow","lime/app/Application.hx",306,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_335_setPreloader,"lime.app.Application","setPreloader",0xe5520ed8,"lime.app.Application.setPreloader","lime/app/Application.hx",335,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_357_get_frameRate,"lime.app.Application","get_frameRate",0x719f92a0,"lime.app.Application.get_frameRate","lime/app/Application.hx",357,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_364_set_frameRate,"lime.app.Application","set_frameRate",0xb6a574ac,"lime.app.Application.set_frameRate","lime/app/Application.hx",364,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_371_get_preloader,"lime.app.Application","get_preloader",0xbaf66569,"lime.app.Application.get_preloader","lime/app/Application.hx",371,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_378_get_renderer,"lime.app.Application","get_renderer",0xa67be3b0,"lime.app.Application.get_renderer","lime/app/Application.hx",378,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_385_get_renderers,"lime.app.Application","get_renderers",0x05eb56c3,"lime.app.Application.get_renderers","lime/app/Application.hx",385,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_392_get_window,"lime.app.Application","get_window",0xc86a4d1d,"lime.app.Application.get_window","lime/app/Application.hx",392,0x8bc55476)
HX_LOCAL_STACK_FRAME(_hx_pos_da4fb7bee4c62773_399_get_windows,"lime.app.Application","get_windows",0x94992cb6,"lime.app.Application.get_windows","lime/app/Application.hx",399,0x8bc55476)
namespace lime{
namespace app{

void Application_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_da4fb7bee4c62773_20_new)
HXLINE(  55)		this->onUpdate =  ::lime::app::_Event_Int_Void_obj::__alloc( HX_CTX );
HXLINE( 106)		super::__construct();
HXLINE( 108)		if (hx::IsNull( ::lime::app::Application_obj::current )) {
HXLINE( 110)			::lime::app::Application_obj::current = hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 114)		this->modules = ::Array_obj< ::Dynamic>::__new();
HXLINE( 115)		this->windowByID =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 117)		this->backend =  ::lime::_backend::native::NativeApplication_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
HXLINE( 119)		this->registerModule(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Application_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_aca430172aa84436_85___init__)
HXDLIN(  85)		 ::Dynamic init = hx::ClassOf< ::lime::_backend::native::NativeApplication >();
            	}


void Application_obj::addModule(::Dynamic module){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_128_addModule)
HXLINE( 130)		::lime::app::IModule_obj::registerModule(module,hx::ObjectPtr<OBJ_>(this));
HXLINE( 131)		this->modules->push(module);
HXLINE( 133)		if ((this->_hx___renderers->length > (int)0)) {
HXLINE( 135)			int _g = (int)0;
HXDLIN( 135)			::Array< ::Dynamic> _g1 = this->_hx___renderers;
HXDLIN( 135)			while((_g < _g1->length)){
HXLINE( 135)				 ::lime::graphics::Renderer renderer = _g1->__get(_g).StaticCast<  ::lime::graphics::Renderer >();
HXDLIN( 135)				_g = (_g + (int)1);
HXLINE( 137)				::lime::app::IModule_obj::addRenderer(module,renderer);
            			}
            		}
HXLINE( 143)		if ((this->_hx___windows->length > (int)0)) {
HXLINE( 145)			int _g2 = (int)0;
HXDLIN( 145)			::Array< ::Dynamic> _g11 = this->_hx___windows;
HXDLIN( 145)			while((_g2 < _g11->length)){
HXLINE( 145)				 ::lime::ui::Window window = _g11->__get(_g2).StaticCast<  ::lime::ui::Window >();
HXDLIN( 145)				_g2 = (_g2 + (int)1);
HXLINE( 147)				::lime::app::IModule_obj::addWindow(module,window);
            			}
            		}
HXLINE( 153)		::lime::app::IModule_obj::setPreloader(module,this->_hx___preloader);
            	}
...
void Application_obj::addRenderer( ::lime::graphics::Renderer renderer){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_163_addRenderer)
HXLINE( 165)		this->super::addRenderer(renderer);
HXLINE( 167)		{
HXLINE( 167)			int _g = (int)0;
HXDLIN( 167)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 167)			while((_g < _g1->length)){
HXLINE( 167)				::Dynamic module = _g1->__get(_g);
HXDLIN( 167)				_g = (_g + (int)1);
HXLINE( 169)				::lime::app::IModule_obj::addRenderer(module,renderer);
            			}
            		}
            	}
...
void Application_obj::create( ::Dynamic config){
            	HX_GC_STACKFRAME(&_hx_pos_da4fb7bee4c62773_182_create)
HXLINE( 184)		this->config = config;
HXLINE( 186)		this->backend->create(config);
HXLINE( 188)		if (hx::IsNotNull( config )) {
HXLINE( 190)			if (::Reflect_obj::hasField(config,HX_("fps",e9,c7,4d,00))) {
HXLINE( 192)				this->backend->setFrameRate(( (Float)(config->__Field(HX_("fps",e9,c7,4d,00),hx::paccDynamic)) ));
            			}
HXLINE( 196)			if (::Reflect_obj::hasField(config,HX_("windows",83,de,74,e8))) {
HXLINE( 198)				int _g = (int)0;
HXDLIN( 198)				::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic)) );
HXDLIN( 198)				while((_g < _g1->length)){
HXLINE( 198)					 ::Dynamic windowConfig = _g1->__get(_g);
HXDLIN( 198)					_g = (_g + (int)1);
HXLINE( 200)					 ::lime::ui::Window window =  ::lime::ui::Window_obj::__alloc( HX_CTX ,windowConfig);
HXLINE( 201)					this->createWindow(window);
            				}
            			}
HXLINE( 211)			bool _hx_tmp;
HXDLIN( 211)			if (hx::IsNotNull( this->_hx___preloader )) {
HXLINE( 211)				_hx_tmp = this->_hx___preloader->complete;
            			}
            			else {
HXLINE( 211)				_hx_tmp = true;
            			}
HXDLIN( 211)			if (_hx_tmp) {
HXLINE( 213)				this->setPreloader(this->_hx___preloader);
HXLINE( 215)				{
HXLINE( 215)					int _g2 = (int)0;
HXDLIN( 215)					::Array< ::Dynamic> _g11 = this->modules;
HXDLIN( 215)					while((_g2 < _g11->length)){
HXLINE( 215)						::Dynamic module = _g11->__get(_g2);
HXDLIN( 215)						_g2 = (_g2 + (int)1);
HXLINE( 217)						this->setPreloader(this->_hx___preloader);
            					}
            				}
            			}
            		}
...
void Application_obj::createWindow( ::lime::ui::Window window){
            	HX_GC_STACKFRAME(&_hx_pos_da4fb7bee4c62773_233_createWindow)
HXLINE( 235)		this->super::addWindow(window);
HXLINE( 237)		{
HXLINE( 237)			int _g = (int)0;
HXDLIN( 237)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 237)			while((_g < _g1->length)){
HXLINE( 237)				::Dynamic module = _g1->__get(_g);
HXDLIN( 237)				_g = (_g + (int)1);
HXLINE( 239)				::lime::app::IModule_obj::addWindow(module,window);
            			}
            		}
HXLINE( 243)		if (hx::IsNull( window->renderer )) {
HXLINE( 245)			 ::lime::graphics::Renderer renderer =  ::lime::graphics::Renderer_obj::__alloc( HX_CTX ,window);
HXLINE( 246)			this->addRenderer(renderer);
            		}
HXLINE( 250)		window->create(hx::ObjectPtr<OBJ_>(this));
HXLINE( 252)		this->windowByID->set(window->id,window);
HXLINE( 254)		window->onCreate->dispatch();
            	}
...
int Application_obj::exec(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_265_exec)
HXLINE( 267)		::lime::app::Application_obj::current = hx::ObjectPtr<OBJ_>(this);
HXLINE( 269)		return this->backend->exec();
            	}
...
void Application_obj::onModuleExit(int code){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_276_onModuleExit)
HXDLIN( 276)		this->backend->exit();
            	}


void Application_obj::onWindowClose( ::lime::ui::Window window){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_283_onWindowClose)
HXDLIN( 283)		this->removeWindow(window);
            	}


void Application_obj::removeModule(::Dynamic module){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_294_removeModule)
HXDLIN( 294)		if (hx::IsNotNull( module )) {
HXLINE( 296)			::lime::app::IModule_obj::unregisterModule(module,hx::ObjectPtr<OBJ_>(this));
HXLINE( 297)			this->modules->remove(module);
            		}
            	}
...
void Application_obj::removeWindow( ::lime::ui::Window window){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_306_removeWindow)
HXDLIN( 306)		bool _hx_tmp;
HXDLIN( 306)		if (hx::IsNotNull( window )) {
HXDLIN( 306)			_hx_tmp = this->windowByID->exists(window->id);
            		}
            		else {
HXDLIN( 306)			_hx_tmp = false;
            		}
HXDLIN( 306)		if (_hx_tmp) {
HXLINE( 308)			this->_hx___windows->remove(window);
HXLINE( 309)			this->windowByID->remove(window->id);
HXLINE( 310)			window->close();
HXLINE( 312)			if (hx::IsNotNull( window->renderer )) {
HXLINE( 314)				this->removeRenderer(window->renderer);
            			}
HXLINE( 318)			if (hx::IsEq( this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >(),window )) {
HXLINE( 320)				this->window = null();
            			}
HXLINE( 324)			if ((this->_hx___windows->length == (int)0)) {
HXLINE( 326)				::lime::_hx_system::System_obj::exit((int)0);
            			}
            		}
            	}
...
void Application_obj::setPreloader( ::lime::app::Preloader preloader){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_335_setPreloader)
HXLINE( 337)		this->super::setPreloader(preloader);
HXLINE( 339)		{
HXLINE( 339)			int _g = (int)0;
HXDLIN( 339)			::Array< ::Dynamic> _g1 = this->modules;
HXDLIN( 339)			while((_g < _g1->length)){
HXLINE( 339)				::Dynamic module = _g1->__get(_g);
HXDLIN( 339)				_g = (_g + (int)1);
HXLINE( 341)				::lime::app::IModule_obj::setPreloader(module,preloader);
            			}
            		}
            	}
...
Float Application_obj::get_frameRate(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_357_get_frameRate)
HXDLIN( 357)		return this->backend->getFrameRate();
            	}
...
Float Application_obj::set_frameRate(Float value){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_364_set_frameRate)
HXDLIN( 364)		return this->backend->setFrameRate(value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Application_obj,set_frameRate,return )
 ...
 ::lime::app::Preloader Application_obj::get_preloader(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_371_get_preloader)
HXDLIN( 371)		return this->_hx___preloader;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_preloader,return )
 ...
 ::lime::graphics::Renderer Application_obj::get_renderer(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_378_get_renderer)
HXDLIN( 378)		return this->_hx___renderers->__get((int)0).StaticCast<  ::lime::graphics::Renderer >();
            	}
...
::Array< ::Dynamic> Application_obj::get_renderers(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_385_get_renderers)
HXDLIN( 385)		return this->_hx___renderers;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Application_obj,get_renderers,return )
 ...
 ::lime::ui::Window Application_obj::get_window(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_392_get_window)
HXDLIN( 392)		return this->_hx___windows->__get((int)0).StaticCast<  ::lime::ui::Window >();
            	}
...
::Array< ::Dynamic> Application_obj::get_windows(){
            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_399_get_windows)
HXDLIN( 399)		return this->_hx___windows;
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_7f97fc5a87c59eff_83_new,"haxe.xml._Fast.HasNodeAccess","new",0xd184aba0,"haxe.xml._Fast.HasNodeAccess.new","E:\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",83,0x8fa8b178)
namespace haxe{
namespace xml{
namespace _Fast{

void HasNodeAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_7f97fc5a87c59eff_83_new)

...
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_144_get_alpha,"openfl.filters.GlowFilter","get_alpha",0x780a0d7d,"openfl.filters.GlowFilter.get_alpha","openfl/filters/GlowFilter.hx",144,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_149_set_alpha,"openfl.filters.GlowFilter","set_alpha",0x5b5af989,"openfl.filters.GlowFilter.set_alpha","openfl/filters/GlowFilter.hx",149,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_159_get_blurX,"openfl.filters.GlowFilter","get_blurX",0x0b7475f0,"openfl.filters.GlowFilter.get_blurX","openfl/filters/GlowFilter.hx",159,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_164_set_blurX,"openfl.filters.GlowFilter","set_blurX",0xeec561fc,"openfl.filters.GlowFilter.set_blurX","openfl/filters/GlowFilter.hx",164,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_179_get_blurY,"openfl.filters.GlowFilter","get_blurY",0x0b7475f1,"openfl.filters.GlowFilter.get_blurY","openfl/filters/GlowFilter.hx",179,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_184_set_blurY,"openfl.filters.GlowFilter","set_blurY",0xeec561fd,"openfl.filters.GlowFilter.set_blurY","openfl/filters/GlowFilter.hx",184,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_199_get_color,"openfl.filters.GlowFilter","get_color",0xa0cfd782,"openfl.filters.GlowFilter.get_color","openfl/filters/GlowFilter.hx",199,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_204_set_color,"openfl.filters.GlowFilter","set_color",0x8420c38e,"openfl.filters.GlowFilter.set_color","openfl/filters/GlowFilter.hx",204,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_214_get_inner,"openfl.filters.GlowFilter","get_inner",0x148f97b5,"openfl.filters.GlowFilter.get_inner","openfl/filters/GlowFilter.hx",214,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_219_set_inner,"openfl.filters.GlowFilter","set_inner",0xf7e083c1,"openfl.filters.GlowFilter.set_inner","openfl/filters/GlowFilter.hx",219,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_229_get_knockout,"openfl.filters.GlowFilter","get_knockout",0xe353a13b,"openfl.filters.GlowFilter.get_knockout","openfl/filters/GlowFilter.hx",229,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_234_set_knockout,"openfl.filters.GlowFilter","set_knockout",0xf84cc4af,"openfl.filters.GlowFilter.set_knockout","openfl/filters/GlowFilter.hx",234,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_244_get_quality,"openfl.filters.GlowFilter","get_quality",0xaafc709e,"openfl.filters.GlowFilter.get_quality","openfl/filters/GlowFilter.hx",244,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_249_set_quality,"openfl.filters.GlowFilter","set_quality",0xb56977aa,"openfl.filters.GlowFilter.set_quality","openfl/filters/GlowFilter.hx",249,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_266_get_strength,"openfl.filters.GlowFilter","get_strength",0x023cc9c2,"openfl.filters.GlowFilter.get_strength","openfl/filters/GlowFilter.hx",266,0x5f568606)
HX_LOCAL_STACK_FRAME(_hx_pos_f54e58291eefcbc3_271_set_strength,"openfl.filters.GlowFilter","set_strength",0x1735ed36,"openfl.filters.GlowFilter.set_strength","openfl/filters/GlowFilter.hx",271,0x5f568606)
...
HXLINE( 111)		if ((pass <= this->_hx___horizontalPasses)) {
HXLINE( 113)			Float scale = ::Math_obj::pow(((Float)0.5),((int)pass >> (int)(int)1));
HXLINE( 114)			::Array< Float > _hx_tmp = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value;
HXDLIN( 114)			_hx_tmp[(int)0] = (this->get_blurX() * scale);
HXLINE( 115)			::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value[(int)1] = (int)0;
            		}
            		else {
HXLINE( 119)			Float scale1 = ::Math_obj::pow(((Float)0.5),((int)(pass - this->_hx___horizontalPasses) >> (int)(int)1));
HXLINE( 120)			::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value[(int)0] = (int)0;
HXLINE( 121)			::Array< Float > _hx_tmp1 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value;
HXDLIN( 121)			_hx_tmp1[(int)1] = (this->get_blurY() * scale1);
            		}
HXLINE( 125)		::Array< Float > _hx_tmp2 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uColor->value;
HXDLIN( 125)		_hx_tmp2[(int)0] = ((Float)((int)((int)this->get_color() >> (int)(int)16) & (int)(int)255) / (Float)(int)255);
HXLINE( 126)		::Array< Float > _hx_tmp3 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uColor->value;
HXDLIN( 126)		_hx_tmp3[(int)1] = ((Float)((int)((int)this->get_color() >> (int)(int)8) & (int)(int)255) / (Float)(int)255);
HXLINE( 127)		::Array< Float > _hx_tmp4 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uColor->value;
HXDLIN( 127)		_hx_tmp4[(int)2] = ((Float)((int)this->get_color() & (int)(int)255) / (Float)(int)255);
HXLINE( 128)		::Array< Float > _hx_tmp5 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uColor->value;
HXDLIN( 128)		_hx_tmp5[(int)3] = this->get_alpha();
HXLINE( 130)		return ::openfl::filters::GlowFilter_obj::_hx___glowShader;
            	}


Float GlowFilter_obj::get_alpha(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_144_get_alpha)
...
Float GlowFilter_obj::set_alpha(Float value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_149_set_alpha)
...
Float GlowFilter_obj::get_blurX(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_159_get_blurX)
HXDLIN( 159)		return this->_hx___blurX;
            	}
...
Float GlowFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_164_set_blurX)
HXLINE( 166)		if ((value != this->_hx___blurX)) {
HXLINE( 167)			this->_hx___blurX = value;
HXLINE( 168)			this->_hx___renderDirty = true;
HXLINE( 169)			int _hx_tmp;
HXDLIN( 169)			if ((value > (int)0)) {
HXLINE( 169)				_hx_tmp = ::Math_obj::ceil((value * ((Float)1.5)));
            			}
            			else {
HXLINE( 169)				_hx_tmp = (int)0;
            			}
HXDLIN( 169)			this->_hx___leftExtension = _hx_tmp;
HXLINE( 170)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
Float GlowFilter_obj::get_blurY(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_179_get_blurY)
HXDLIN( 179)		return this->_hx___blurY;
            	}
...
Float GlowFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_184_set_blurY)
HXLINE( 186)		if ((value != this->_hx___blurY)) {
HXLINE( 187)			this->_hx___blurY = value;
HXLINE( 188)			this->_hx___renderDirty = true;
HXLINE( 189)			int _hx_tmp;
HXDLIN( 189)			if ((value > (int)0)) {
HXLINE( 189)				_hx_tmp = ::Math_obj::ceil((value * ((Float)1.5)));
            			}
            			else {
HXLINE( 189)				_hx_tmp = (int)0;
            			}
HXDLIN( 189)			this->_hx___topExtension = _hx_tmp;
HXLINE( 190)			this->_hx___bottomExtension = this->_hx___topExtension;
            		}
...
int GlowFilter_obj::get_color(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_199_get_color)
HXDLIN( 199)		return this->_hx___color;
            	}
...
int GlowFilter_obj::set_color(int value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_204_set_color)
HXLINE( 206)		if ((value != this->_hx___color)) {
HXLINE( 206)			this->_hx___renderDirty = true;
            		}
HXLINE( 207)		return (this->_hx___color = value);
            	}
...
bool GlowFilter_obj::get_inner(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_214_get_inner)
HXDLIN( 214)		return this->_hx___inner;
            	}
...
bool GlowFilter_obj::set_inner(bool value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_219_set_inner)
HXLINE( 221)		if ((value != this->_hx___inner)) {
HXLINE( 221)			this->_hx___renderDirty = true;
            		}
HXLINE( 222)		return (this->_hx___inner = value);
            	}
...
bool GlowFilter_obj::get_knockout(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_229_get_knockout)
HXDLIN( 229)		return this->_hx___knockout;
            	}
...
bool GlowFilter_obj::set_knockout(bool value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_234_set_knockout)
HXLINE( 236)		if ((value != this->_hx___knockout)) {
HXLINE( 236)			this->_hx___renderDirty = true;
            		}
HXLINE( 237)		return (this->_hx___knockout = value);
            	}
...
int GlowFilter_obj::get_quality(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_244_get_quality)
HXDLIN( 244)		return this->_hx___quality;
            	}
...
int GlowFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_249_set_quality)
HXLINE( 253)		int _hx_tmp;
HXDLIN( 253)		if ((this->_hx___blurX <= (int)0)) {
HXLINE( 253)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 253)			Float _hx_tmp1 = this->_hx___blurX;
HXDLIN( 253)			_hx_tmp = (::Math_obj::round((_hx_tmp1 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 253)		this->_hx___horizontalPasses = _hx_tmp;
HXLINE( 254)		int _hx_tmp2;
HXDLIN( 254)		if ((this->_hx___blurY <= (int)0)) {
HXLINE( 254)			_hx_tmp2 = (int)0;
            		}
            		else {
HXLINE( 254)			Float _hx_tmp3 = this->_hx___blurY;
HXDLIN( 254)			_hx_tmp2 = (::Math_obj::round((_hx_tmp3 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 254)		this->_hx___verticalPasses = _hx_tmp2;
HXLINE( 256)		this->_hx___numShaderPasses = (this->_hx___horizontalPasses + this->_hx___verticalPasses);
HXLINE( 258)		if ((value != this->_hx___quality)) {
HXLINE( 258)			this->_hx___renderDirty = true;
            		}
HXLINE( 259)		return (this->_hx___quality = value);
            	}
...
Float GlowFilter_obj::get_strength(){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_266_get_strength)
HXDLIN( 266)		return this->_hx___strength;
            	}
...
Float GlowFilter_obj::set_strength(Float value){
            	HX_STACKFRAME(&_hx_pos_f54e58291eefcbc3_271_set_strength)
HXLINE( 273)		if ((value != this->_hx___strength)) {
HXLINE( 273)			this->_hx___renderDirty = true;
            		}
HXLINE( 274)		return (this->_hx___strength = value);
            	}

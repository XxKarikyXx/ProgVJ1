...
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_62_new,"lime.graphics.ImageBuffer","new",0xb261c9e3,"lime.graphics.ImageBuffer.new","lime/graphics/ImageBuffer.hx",62,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_75_clone,"lime.graphics.ImageBuffer","clone",0x1504b3a0,"lime.graphics.ImageBuffer.clone","lime/graphics/ImageBuffer.hx",75,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_159_get_src,"lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",159,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_166_set_src,"lime.graphics.ImageBuffer","set_src",0x8a4a778a,"lime.graphics.ImageBuffer.set_src","lime/graphics/ImageBuffer.hx",166,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_198_get_stride,"lime.graphics.ImageBuffer","get_stride",0xb11b1cbf,"lime.graphics.ImageBuffer.get_stride","lime/graphics/ImageBuffer.hx",198,0x6475c2cd)
namespace lime{
namespace graphics{
...
int bitsPerPixel = __o_bitsPerPixel.Default(32);
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_62_new)
HXLINE(  64)		this->data = data;
HXLINE(  65)		this->width = width;
HXLINE(  66)		this->height = height;
HXLINE(  67)		this->bitsPerPixel = bitsPerPixel;
HXLINE(  68)		int _hx_tmp;
HXDLIN(  68)		if (hx::IsNull( format )) {
HXLINE(  68)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE(  68)			_hx_tmp = format;
            		}
HXDLIN(  68)		this->format = _hx_tmp;
HXLINE(  69)		this->premultiplied = false;
HXLINE(  70)		this->transparent = true;
            	}
...
bool ImageBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::ImageBuffer ImageBuffer_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_890299056ccc780d_75_clone)
HXLINE(  77)		 ::lime::graphics::ImageBuffer buffer =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this->data,this->width,this->height,this->bitsPerPixel,null());
HXLINE( 121)		if (hx::IsNotNull( this->data )) {
HXLINE( 123)			 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc(this->data->byteLength);
HXLINE( 124)			bytes->blit((int)0,buffer->data->buffer,(int)0,this->data->byteLength);
HXLINE( 125)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 125)			if (hx::IsNotNull( bytes )) {
HXLINE( 125)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 125)				int in_byteOffset = (int)0;
...
HXDLIN( 125)			buffer->data = this1;
            		}
HXLINE( 130)		buffer->bitsPerPixel = this->bitsPerPixel;
HXLINE( 131)		buffer->format = this->format;
HXLINE( 132)		buffer->premultiplied = this->premultiplied;
HXLINE( 133)		buffer->transparent = this->transparent;
HXLINE( 134)		return buffer;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,clone,return )
 ...
 ::Dynamic ImageBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_159_get_src)
HXDLIN( 159)		return this->_hx___srcCustom;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,get_src,return )
 ...
 ::Dynamic ImageBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_166_set_src)
HXLINE( 187)		this->_hx___srcCustom = value;
...
int ImageBuffer_obj::get_stride(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_198_get_stride)
HXDLIN( 198)		return (this->width * (int)4);
            	}

...
HXLINE(1413)			height = ::openfl::_internal::stage3D::opengl::GLContext3D_obj::context->backBufferHeight;
HXLINE(1414)			offsetX = ::Std_obj::_hx_int(::openfl::_internal::stage3D::opengl::GLContext3D_obj::context->_hx___stage3D->get_x());
HXLINE(1415)			offsetY = ::Std_obj::_hx_int(::openfl::_internal::stage3D::opengl::GLContext3D_obj::context->_hx___stage3D->get_y());
            		}
HXLINE(1419)		 ::lime::_backend::native::NativeGLRenderContext _hx_tmp = ::openfl::_internal::stage3D::opengl::GLContext3D_obj::gl;
HXDLIN(1419)		int _hx_tmp1 = (::Std_obj::_hx_int(::openfl::_internal::stage3D::opengl::GLContext3D_obj::context->_hx___scissorRectangle->x) + offsetX);
HXLINE(1420)		int _hx_tmp2 = (height - ::Std_obj::_hx_int(::openfl::_internal::stage3D::opengl::GLContext3D_obj::context->_hx___scissorRectangle->y));
HXDLIN(1420)		int _hx_tmp3 = ((_hx_tmp2 - ::Std_obj::_hx_int(::openfl::_internal::stage3D::opengl::GLContext3D_obj::context->_hx___scissorRectangle->height)) + offsetY);
HXLINE(1421)		int _hx_tmp4 = ::Std_obj::_hx_int(::openfl::_internal::stage3D::opengl::GLContext3D_obj::context->_hx___scissorRectangle->width);
HXLINE(1419)		_hx_tmp->scissor(_hx_tmp1,_hx_tmp3,_hx_tmp4,::Std_obj::_hx_int(::openfl::_internal::stage3D::opengl::GLContext3D_obj::context->_hx___scissorRectangle->height));
HXLINE(1424)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
            	}

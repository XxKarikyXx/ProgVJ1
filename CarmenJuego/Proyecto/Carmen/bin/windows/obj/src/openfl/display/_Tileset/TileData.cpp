...
HXLINE( 227)			this->_hx___uvX = ((Float)this->x / (Float)bitmapData->width);
HXLINE( 228)			this->_hx___uvY = ((Float)this->y / (Float)bitmapData->height);
HXLINE( 229)			this->_hx___uvWidth = ((Float)(this->x + this->width) / (Float)bitmapData->width);
HXLINE( 230)			this->_hx___uvHeight = ((Float)(this->y + this->height) / (Float)bitmapData->height);
            		}
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_f12f05933266a8d8_37_new,"openfl._internal.text.TextLayoutGroup","new",0x78a7f549,"openfl._internal.text.TextLayoutGroup.new","openfl/_internal/text/TextLayoutGroup.hx",37,0xbe6fd786)
HX_LOCAL_STACK_FRAME(_hx_pos_f12f05933266a8d8_51_getAdvance,"openfl._internal.text.TextLayoutGroup","getAdvance",0x5f8fc8c3,"openfl._internal.text.TextLayoutGroup.getAdvance","openfl/_internal/text/TextLayoutGroup.hx",51,0xbe6fd786)
namespace openfl{
namespace _internal{
namespace text{

void TextLayoutGroup_obj::__construct( ::openfl::text::TextFormat format,int startIndex,int endIndex){
            	HX_STACKFRAME(&_hx_pos_f12f05933266a8d8_37_new)
HXLINE(  39)		this->format = format;
HXLINE(  40)		this->startIndex = startIndex;
HXLINE(  41)		this->endIndex = endIndex;
            	}
...
Float TextLayoutGroup_obj::getAdvance(int index){
            	HX_STACKFRAME(&_hx_pos_f12f05933266a8d8_51_getAdvance)
HXDLIN(  51)		bool _hx_tmp;
HXDLIN(  51)		if ((index >= (int)0)) {
HXDLIN(  51)			_hx_tmp = (index < this->positions->length);
            		}
            		else {
HXDLIN(  51)			_hx_tmp = false;
            		}
HXDLIN(  51)		if (_hx_tmp) {
HXDLIN(  51)			return this->positions->__get(index).StaticCast<  ::lime::text::GlyphPosition >()->advance->x;
            		}
            		else {

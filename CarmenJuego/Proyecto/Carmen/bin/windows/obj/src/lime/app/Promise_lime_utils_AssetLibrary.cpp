...
HX_DEFINE_STACK_FRAME(_hx_pos_fb3f90ed3afd7756_36_new,"lime.app.Promise_lime_utils_AssetLibrary","new",0x0f34710b,"lime.app.Promise_lime_utils_AssetLibrary.new","lime/app/Promise.hx",36,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_fb3f90ed3afd7756_41_complete,"lime.app.Promise_lime_utils_AssetLibrary","complete",0xfdaa142e,"lime.app.Promise_lime_utils_AssetLibrary.complete","lime/app/Promise.hx",41,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_fb3f90ed3afd7756_67_completeWith,"lime.app.Promise_lime_utils_AssetLibrary","completeWith",0xd4846554,"lime.app.Promise_lime_utils_AssetLibrary.completeWith","lime/app/Promise.hx",67,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_fb3f90ed3afd7756_79_error,"lime.app.Promise_lime_utils_AssetLibrary","error",0x73f42d33,"lime.app.Promise_lime_utils_AssetLibrary.error","lime/app/Promise.hx",79,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_fb3f90ed3afd7756_105_progress,"lime.app.Promise_lime_utils_AssetLibrary","progress",0x040d0b22,"lime.app.Promise_lime_utils_AssetLibrary.progress","lime/app/Promise.hx",105,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_fb3f90ed3afd7756_135_get_isComplete,"lime.app.Promise_lime_utils_AssetLibrary","get_isComplete",0x9cee3441,"lime.app.Promise_lime_utils_AssetLibrary.get_isComplete","lime/app/Promise.hx",135,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_fb3f90ed3afd7756_142_get_isError,"lime.app.Promise_lime_utils_AssetLibrary","get_isError",0x4d6b9340,"lime.app.Promise_lime_utils_AssetLibrary.get_isError","lime/app/Promise.hx",142,0x10ba4f0b)
namespace lime{
namespace app{

void Promise_lime_utils_AssetLibrary_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_fb3f90ed3afd7756_36_new)
...
bool Promise_lime_utils_AssetLibrary_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::app::Promise_lime_utils_AssetLibrary Promise_lime_utils_AssetLibrary_obj::complete( ::lime::utils::AssetLibrary data){
            	HX_STACKFRAME(&_hx_pos_fb3f90ed3afd7756_41_complete)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_utils_AssetLibrary_obj,complete,return )
 ...
 ::lime::app::Promise_lime_utils_AssetLibrary Promise_lime_utils_AssetLibrary_obj::completeWith( ::lime::app::Future future){
            	HX_STACKFRAME(&_hx_pos_fb3f90ed3afd7756_67_completeWith)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_utils_AssetLibrary_obj,completeWith,return )
 ...
 ::lime::app::Promise_lime_utils_AssetLibrary Promise_lime_utils_AssetLibrary_obj::error( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_fb3f90ed3afd7756_79_error)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_utils_AssetLibrary_obj,error,return )
 ...
 ::lime::app::Promise_lime_utils_AssetLibrary Promise_lime_utils_AssetLibrary_obj::progress(int progress,int total){
            	HX_STACKFRAME(&_hx_pos_fb3f90ed3afd7756_105_progress)
...
bool Promise_lime_utils_AssetLibrary_obj::get_isComplete(){
            	HX_STACKFRAME(&_hx_pos_fb3f90ed3afd7756_135_get_isComplete)
...
bool Promise_lime_utils_AssetLibrary_obj::get_isError(){
            	HX_STACKFRAME(&_hx_pos_fb3f90ed3afd7756_142_get_isError)

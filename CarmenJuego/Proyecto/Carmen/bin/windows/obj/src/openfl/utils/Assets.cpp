...
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_490_loadLibrary,"openfl.utils.Assets","loadLibrary",0x25ad1de5,"openfl.utils.Assets.loadLibrary","openfl/utils/Assets.hx",490,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_508_loadMusic,"openfl.utils.Assets","loadMusic",0x8c95590f,"openfl.utils.Assets.loadMusic","openfl/utils/Assets.hx",508,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_498_loadMusic,"openfl.utils.Assets","loadMusic",0x8c95590f,"openfl.utils.Assets.loadMusic","openfl/utils/Assets.hx",498,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_543_loadMovieClip,"openfl.utils.Assets","loadMovieClip",0xc0b3080a,"openfl.utils.Assets.loadMovieClip","openfl/utils/Assets.hx",543,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_591_loadSound,"openfl.utils.Assets","loadSound",0xfd071539,"openfl.utils.Assets.loadSound","openfl/utils/Assets.hx",591,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_583_loadSound,"openfl.utils.Assets","loadSound",0xfd071539,"openfl.utils.Assets.loadSound","openfl/utils/Assets.hx",583,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_619_loadText,"openfl.utils.Assets","loadText",0x7b73bf83,"openfl.utils.Assets.loadText","openfl/utils/Assets.hx",619,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_634_registerLibrary,"openfl.utils.Assets","registerLibrary",0xb100bb48,"openfl.utils.Assets.registerLibrary","openfl/utils/Assets.hx",634,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_641_removeEventListener,"openfl.utils.Assets","removeEventListener",0xbaaab03a,"openfl.utils.Assets.removeEventListener","openfl/utils/Assets.hx",641,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_648_resolveClass,"openfl.utils.Assets","resolveClass",0x568fe73c,"openfl.utils.Assets.resolveClass","openfl/utils/Assets.hx",648,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_653_resolveEnum,"openfl.utils.Assets","resolveEnum",0xf3f0c87d,"openfl.utils.Assets.resolveEnum","openfl/utils/Assets.hx",653,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_674_unloadLibrary,"openfl.utils.Assets","unloadLibrary",0x577a902c,"openfl.utils.Assets.unloadLibrary","openfl/utils/Assets.hx",674,0x4e64919e)
HX_LOCAL_STACK_FRAME(_hx_pos_4176bcd8576208c2_688_LimeAssets_onChange,"openfl.utils.Assets","LimeAssets_onChange",0xfa955f26,"openfl.utils.Assets.LimeAssets_onChange","openfl/utils/Assets.hx",688,0x4e64919e)
...
HXLINE(  68)			_hx_tmp1 = ( (bool)(::openfl::utils::Assets_obj::cache->__Field(HX_("get_enabled",98,64,2b,04),hx::paccDynamic)()) );
            		}
            		else {
...
HXLINE(  90)				_hx_tmp2 = ( (bool)(::openfl::utils::Assets_obj::cache->__Field(HX_("get_enabled",98,64,2b,04),hx::paccDynamic)()) );
            			}
            			else {
...
HXLINE( 225)			_hx_tmp1 = ( (bool)(::openfl::utils::Assets_obj::cache->__Field(HX_("get_enabled",98,64,2b,04),hx::paccDynamic)()) );
            		}
            		else {
...
HXLINE( 247)				_hx_tmp2 = ( (bool)(::openfl::utils::Assets_obj::cache->__Field(HX_("get_enabled",98,64,2b,04),hx::paccDynamic)()) );
            			}
            			else {
...
HXLINE( 289)			_hx_tmp = ( (bool)(::openfl::utils::Assets_obj::cache->__Field(HX_("get_enabled",98,64,2b,04),hx::paccDynamic)()) );
            		}
            		else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadFont,return )
 ...
 ::lime::app::Future Assets_obj::loadLibrary(::String name){
            	HX_STACKFRAME(&_hx_pos_4176bcd8576208c2_490_loadLibrary)
HXLINE( 492)		 ::lime::app::Future future = ::lime::utils::Assets_obj::loadLibrary(name);
HXLINE( 493)		return future;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,loadLibrary,return )
 ...
 ::lime::app::Future Assets_obj::loadMusic(::String id, ::Dynamic __o_useCache){
            		...
            		void _hx_run( ::lime::media::AudioBuffer buffer){
            			HX_GC_STACKFRAME(&_hx_pos_4176bcd8576208c2_508_loadMusic)
HXLINE( 508)			if (hx::IsNotNull( buffer )) {
HXLINE( 513)				 ::openfl::media::Sound sound = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
HXLINE( 516)				bool _hx_tmp;
HXDLIN( 516)				if (useCache) {
HXLINE( 516)					_hx_tmp = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            				}
            				else {
HXLINE( 516)					_hx_tmp = false;
            				}
HXDLIN( 516)				if (_hx_tmp) {
HXLINE( 518)					::openfl::utils::IAssetCache_obj::setSound(::openfl::utils::Assets_obj::cache,id,sound);
            				}
HXLINE( 522)				promise->complete(sound);
            			}
            			else {
HXLINE( 526)				promise->error(((HX_("[Assets] Could not load Sound \"",64,be,27,e3) + id) + HX_("\"",22,00,00,00)));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

 ::Dynamic useCache = __o_useCache.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_4176bcd8576208c2_498_loadMusic)
HXLINE( 500)		if (hx::IsNull( useCache )) {
HXLINE( 500)			useCache = true;
            		}
HXLINE( 504)		 ::lime::app::Promise_openfl_media_Sound promise =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
HXLINE( 506)		::lime::utils::Assets_obj::loadAudioBuffer(id,useCache)->onComplete( ::Dynamic(new _hx_Closure_0(id,promise,useCache)))->onError(promise->error_dyn())->onProgress(promise->progress_dyn());
HXLINE( 531)		return promise->future;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadMusic,return )
 ...
 ::lime::app::Future Assets_obj::loadMovieClip(::String id){
            	HX_GC_STACKFRAME(&_hx_pos_4176bcd8576208c2_543_loadMovieClip)
HXLINE( 545)		 ::lime::app::Promise_openfl_display_MovieClip promise =  ::lime::app::Promise_openfl_display_MovieClip_obj::__alloc( HX_CTX );
HXLINE( 549)		::String libraryName = id.substring((int)0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 550)		::String symbolName = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + (int)1),null());
HXLINE( 551)		 ::lime::utils::AssetLibrary limeLibrary = ::openfl::utils::Assets_obj::getLibrary(libraryName);
HXLINE( 553)		if (hx::IsNotNull( limeLibrary )) {
HXLINE( 555)			if (::Std_obj::is(limeLibrary,hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
HXLINE( 557)				 ::openfl::utils::AssetLibrary library = ( ( ::openfl::utils::AssetLibrary)(limeLibrary) );
HXLINE( 559)				if (library->exists(symbolName,HX_("MOVIE_CLIP",1f,e1,aa,77))) {
HXLINE( 561)					promise->completeWith(library->loadMovieClip(symbolName));
HXLINE( 562)					return promise->future;
            				}
            			}
HXLINE( 568)			promise->error(((HX_("[Assets] There is no MovieClip asset with an ID of \"",8f,8e,f2,7d) + id) + HX_("\"",22,00,00,00)));
            		}
            		else {
HXLINE( 572)			promise->error(((HX_("[Assets] There is no asset library named \"",a0,b4,0a,cd) + libraryName) + HX_("\"",22,00,00,00)));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,loadMovieClip,return )
 ...
 ::lime::app::Future Assets_obj::loadSound(::String id, ::Dynamic __o_useCache){
            		HX_BEGIN_LOCAL_FUNC_S3(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::app::Promise_openfl_media_Sound,promise, ::Dynamic,useCache) HXARGC(1)
            		void _hx_run( ::lime::media::AudioBuffer buffer){
            			HX_GC_STACKFRAME(&_hx_pos_4176bcd8576208c2_591_loadSound)
HXLINE( 591)			if (hx::IsNotNull( buffer )) {
HXLINE( 596)				 ::openfl::media::Sound sound = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
HXLINE( 599)				bool _hx_tmp;
HXDLIN( 599)				if (useCache) {
HXLINE( 599)					_hx_tmp = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            				}
            				else {
HXLINE( 599)					_hx_tmp = false;
            				}
HXDLIN( 599)				if (_hx_tmp) {
HXLINE( 601)					::openfl::utils::IAssetCache_obj::setSound(::openfl::utils::Assets_obj::cache,id,sound);
            				}
HXLINE( 605)				promise->complete(sound);
            			}
            			else {
HXLINE( 609)				promise->error(((HX_("[Assets] Could not load Sound \"",64,be,27,e3) + id) + HX_("\"",22,00,00,00)));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

 ::Dynamic useCache = __o_useCache.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_4176bcd8576208c2_583_loadSound)
HXLINE( 585)		if (hx::IsNull( useCache )) {
HXLINE( 585)			useCache = true;
            		}
HXLINE( 587)		 ::lime::app::Promise_openfl_media_Sound promise =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
HXLINE( 589)		::lime::utils::Assets_obj::loadAudioBuffer(id,useCache)->onComplete( ::Dynamic(new _hx_Closure_0(id,promise,useCache)))->onError(promise->error_dyn())->onProgress(promise->progress_dyn());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadSound,return )
 ...
 ::lime::app::Future Assets_obj::loadText(::String id){
            	HX_STACKFRAME(&_hx_pos_4176bcd8576208c2_619_loadText)
HXLINE( 621)		 ::lime::app::Future future = ::lime::utils::Assets_obj::loadText(id);
HXLINE( 622)		return future;
            	}
...
void Assets_obj::registerLibrary(::String name, ::openfl::utils::AssetLibrary library){
            	HX_STACKFRAME(&_hx_pos_4176bcd8576208c2_634_registerLibrary)
HXDLIN( 634)		::lime::utils::Assets_obj::registerLibrary(name,library);
            	}
...
bool capture = __o_capture.Default(false);
            	HX_STACKFRAME(&_hx_pos_4176bcd8576208c2_641_removeEventListener)
HXDLIN( 641)		::openfl::utils::Assets_obj::dispatcher->removeEventListener(type,listener,capture);
            	}
...
hx::Class Assets_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_4176bcd8576208c2_648_resolveClass)
HXDLIN( 648)		return ::Type_obj::resolveClass(name);
            	}
...
hx::Class Assets_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_4176bcd8576208c2_653_resolveEnum)
HXLINE( 655)		hx::Class value = ::Type_obj::resolveEnum(name);
...
void Assets_obj::unloadLibrary(::String name){
            	HX_STACKFRAME(&_hx_pos_4176bcd8576208c2_674_unloadLibrary)
HXDLIN( 674)		::lime::utils::Assets_obj::unloadLibrary(name);
            	}
...
void Assets_obj::LimeAssets_onChange(){
            	HX_GC_STACKFRAME(&_hx_pos_4176bcd8576208c2_688_LimeAssets_onChange)
HXDLIN( 688)		::openfl::utils::Assets_obj::dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null()));
            	}

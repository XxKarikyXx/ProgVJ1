...
HX_LOCAL_STACK_FRAME(_hx_pos_5c2df8aac0fafee0_67_decompress,"lime.utils.compress.Deflate","decompress",0x4c84c45c,"lime.utils.compress.Deflate.decompress","lime/utils/compress/Deflate.hx",67,0x7e6cac08)
namespace lime{
namespace utils{
namespace compress{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Deflate_obj,compress,return )
 ...
 ::haxe::io::Bytes Deflate_obj::decompress( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_5c2df8aac0fafee0_67_decompress)
HXDLIN(  67)		 ::Dynamic bytes1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  67)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_deflate_decompress(hx::DynamicPtr(bytes),hx::DynamicPtr(bytes1))) );
            	}

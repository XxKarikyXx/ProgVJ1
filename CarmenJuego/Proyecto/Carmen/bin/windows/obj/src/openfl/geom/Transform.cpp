...
HXDLIN( 146)			 ::openfl::_Vector::FloatVector vector =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null(),true);
HXDLIN( 146)			{
...
HXDLIN( 146)					vector->set(i,a->__get(i));
            				}
            			}
...
HXLINE( 167)		Float _hx_tmp = value->rawData->get((int)0);
HXDLIN( 167)		Float _hx_tmp1 = value->rawData->get((int)1);
HXDLIN( 167)		Float _hx_tmp2 = value->rawData->get((int)5);
HXDLIN( 167)		Float _hx_tmp3 = value->rawData->get((int)6);
HXDLIN( 167)		Float _hx_tmp4 = value->rawData->get((int)12);
HXDLIN( 167)		this->_hx___setTransform(_hx_tmp,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,value->rawData->get((int)13));

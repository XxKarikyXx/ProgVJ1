...
HX_DEFINE_STACK_FRAME(_hx_pos_70dc9db4ea0899fa_63_new,"sys.io._Process.Stdout","new",0xc765a8f4,"sys.io._Process.Stdout.new","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",63,0x4b9e5bee)
HX_LOCAL_STACK_FRAME(_hx_pos_70dc9db4ea0899fa_69_readByte,"sys.io._Process.Stdout","readByte",0xa72b886a,"sys.io._Process.Stdout.readByte","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",69,0x4b9e5bee)
HX_LOCAL_STACK_FRAME(_hx_pos_70dc9db4ea0899fa_75_readBytes,"sys.io._Process.Stdout","readBytes",0x9eebd4c9,"sys.io._Process.Stdout.readBytes","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",75,0x4b9e5bee)
namespace sys{
namespace io{
namespace _Process{

void Stdout_obj::__construct( ::Dynamic p,bool out){
            	HX_STACKFRAME(&_hx_pos_70dc9db4ea0899fa_63_new)
HXLINE(  64)		this->p = p;
...
int Stdout_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_70dc9db4ea0899fa_69_readByte)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_70dc9db4ea0899fa_75_readBytes)

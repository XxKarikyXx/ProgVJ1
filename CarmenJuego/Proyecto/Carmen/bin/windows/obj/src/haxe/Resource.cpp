...
HX_LOCAL_STACK_FRAME(_hx_pos_6ff5e7017ad4557a_33_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","E:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Resource.hx",33,0xb959d5cf)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_6ff5e7017ad4557a_33_getBytes)

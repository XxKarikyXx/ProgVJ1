...
HX_DEFINE_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_33_new,"openfl.geom.Point","new",0xa6fb3c0e,"openfl.geom.Point.new","openfl/geom/Point.hx",33,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_43_add,"openfl.geom.Point","add",0xa6f15dcf,"openfl.geom.Point.add","openfl/geom/Point.hx",43,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_50_clone,"openfl.geom.Point","clone",0x787f468b,"openfl.geom.Point.clone","openfl/geom/Point.hx",50,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_55_copyFrom,"openfl.geom.Point","copyFrom",0x660e8951,"openfl.geom.Point.copyFrom","openfl/geom/Point.hx",55,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_74_equals,"openfl.geom.Point","equals",0xa8838351,"openfl.geom.Point.equals","openfl/geom/Point.hx",74,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_88_normalize,"openfl.geom.Point","normalize",0x05c199bb,"openfl.geom.Point.normalize","openfl/geom/Point.hx",88,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_103_offset,"openfl.geom.Point","offset",0x48d02ca5,"openfl.geom.Point.offset","openfl/geom/Point.hx",103,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_118_setTo,"openfl.geom.Point","setTo",0xaa4bc4eb,"openfl.geom.Point.setTo","openfl/geom/Point.hx",118,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_127_subtract,"openfl.geom.Point","subtract",0x95bef2a6,"openfl.geom.Point.subtract","openfl/geom/Point.hx",127,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_134_toString,"openfl.geom.Point","toString",0xd61c4e3e,"openfl.geom.Point.toString","openfl/geom/Point.hx",134,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_139___toLimeVector2,"openfl.geom.Point","__toLimeVector2",0x318eb74d,"openfl.geom.Point.__toLimeVector2","openfl/geom/Point.hx",139,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_162_get_length,"openfl.geom.Point","get_length",0x11c48ac1,"openfl.geom.Point.get_length","openfl/geom/Point.hx",162,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_63_distance,"openfl.geom.Point","distance",0x09a710c7,"openfl.geom.Point.distance","openfl/geom/Point.hx",63,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_81_interpolate,"openfl.geom.Point","interpolate",0x8bd29e6f,"openfl.geom.Point.interpolate","openfl/geom/Point.hx",81,0x18173b82)
HX_LOCAL_STACK_FRAME(_hx_pos_35745b0e94bdaa0e_113_polar,"openfl.geom.Point","polar",0xf6ae22ec,"openfl.geom.Point.polar","openfl/geom/Point.hx",113,0x18173b82)
...
Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_33_new)
HXLINE(  35)		this->x = x;
HXLINE(  36)		this->y = y;
            	}
...
bool Point_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::geom::Point Point_obj::add( ::openfl::geom::Point v){
            	HX_GC_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_43_add)
HXDLIN(  43)		Float _hx_tmp = (v->x + this->x);
HXDLIN(  43)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(v->y + this->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Point_obj,add,return )
 ...
 ::openfl::geom::Point Point_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_50_clone)
HXDLIN(  50)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,this->x,this->y);
            	}
...
void Point_obj::copyFrom( ::openfl::geom::Point sourcePoint){
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_55_copyFrom)
HXLINE(  57)		this->x = sourcePoint->x;
HXLINE(  58)		this->y = sourcePoint->y;
            	}
...
bool Point_obj::equals( ::openfl::geom::Point toCompare){
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_74_equals)
HXDLIN(  74)		bool _hx_tmp;
HXDLIN(  74)		if (hx::IsNotNull( toCompare )) {
HXDLIN(  74)			_hx_tmp = (toCompare->x == this->x);
            		}
            		else {
HXDLIN(  74)			_hx_tmp = false;
            		}
HXDLIN(  74)		if (_hx_tmp) {
HXDLIN(  74)			return (toCompare->y == this->y);
            		}
            		else {
...
void Point_obj::normalize(Float thickness){
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_88_normalize)
HXDLIN(  88)		bool _hx_tmp;
HXDLIN(  88)		if ((this->x == (int)0)) {
HXDLIN(  88)			_hx_tmp = (this->y == (int)0);
            		}
            		else {
...
HXLINE(  94)			Float norm = (this->x * this->x);
HXDLIN(  94)			Float norm1 = ((Float)thickness / (Float)::Math_obj::sqrt((norm + (this->y * this->y))));
HXLINE(  95)			 ::openfl::geom::Point _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  95)			_hx_tmp1->x = (_hx_tmp1->x * norm1);
HXLINE(  96)			 ::openfl::geom::Point _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  96)			_hx_tmp2->y = (_hx_tmp2->y * norm1);
            		}
            	}
...
void Point_obj::offset(Float dx,Float dy){
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_103_offset)
HXLINE( 105)		 ::openfl::geom::Point _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 105)		_hx_tmp->x = (_hx_tmp->x + dx);
HXLINE( 106)		 ::openfl::geom::Point _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 106)		_hx_tmp1->y = (_hx_tmp1->y + dy);
            	}
...
void Point_obj::setTo(Float xa,Float ya){
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_118_setTo)
HXLINE( 120)		this->x = xa;
HXLINE( 121)		this->y = ya;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Point_obj,setTo,(void))
 ...
 ::openfl::geom::Point Point_obj::subtract( ::openfl::geom::Point v){
            	HX_GC_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_127_subtract)
HXDLIN( 127)		Float _hx_tmp = (this->x - v->x);
HXDLIN( 127)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(this->y - v->y));
            	}
...
::String Point_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_134_toString)
HXDLIN( 134)		return ((((HX_("(x=",ed,c2,1e,00) + this->x) + HX_(", y=",18,15,2e,1d)) + this->y) + HX_(")",29,00,00,00));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Point_obj,toString,return )
 ...
 ::lime::math::Vector2 Point_obj::_hx___toLimeVector2(){
            	HX_GC_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_139___toLimeVector2)
HXLINE( 141)		if (hx::IsNull( ::openfl::geom::Point_obj::_hx___limeVector2 )) {
HXLINE( 143)			::openfl::geom::Point_obj::_hx___limeVector2 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null());
            		}
HXLINE( 147)		{
HXLINE( 147)			 ::lime::math::Vector2 _this = ::openfl::geom::Point_obj::_hx___limeVector2;
HXDLIN( 147)			_this->x = this->x;
HXDLIN( 147)			_this->y = this->y;
            		}
HXLINE( 148)		return ::openfl::geom::Point_obj::_hx___limeVector2;
            	}
...
Float Point_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_162_get_length)
HXDLIN( 162)		Float _hx_tmp = (this->x * this->x);
HXDLIN( 162)		return ::Math_obj::sqrt((_hx_tmp + (this->y * this->y)));
            	}
...
Float Point_obj::distance( ::openfl::geom::Point pt1, ::openfl::geom::Point pt2){
            	HX_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_63_distance)
HXLINE(  65)		Float dx = (pt1->x - pt2->x);
HXLINE(  66)		Float dy = (pt1->y - pt2->y);
HXLINE(  67)		return ::Math_obj::sqrt(((dx * dx) + (dy * dy)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Point_obj,distance,return )
 ...
 ::openfl::geom::Point Point_obj::interpolate( ::openfl::geom::Point pt1, ::openfl::geom::Point pt2,Float f){
            	HX_GC_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_81_interpolate)
HXDLIN(  81)		Float pt21 = pt2->x;
HXDLIN(  81)		Float _hx_tmp = (pt21 + (f * (pt1->x - pt2->x)));
HXDLIN(  81)		Float pt22 = pt2->y;
HXDLIN(  81)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(pt22 + (f * (pt1->y - pt2->y))));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Point_obj,interpolate,return )
 ...
 ::openfl::geom::Point Point_obj::polar(Float len,Float angle){
            	HX_GC_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_113_polar)
HXDLIN( 113)		Float _hx_tmp = (len * ::Math_obj::cos(angle));
HXDLIN( 113)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(len * ::Math_obj::sin(angle)));
            	}

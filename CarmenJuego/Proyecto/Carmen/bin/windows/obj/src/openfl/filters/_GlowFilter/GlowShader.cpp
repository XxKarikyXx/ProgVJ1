...
HX_DEFINE_STACK_FRAME(_hx_pos_3849ff18b8ccdd38_347_new,"openfl.filters._GlowFilter.GlowShader","new",0x65561d5f,"openfl.filters._GlowFilter.GlowShader.new","openfl/filters/GlowFilter.hx",347,0x5f568606)
...
void GlowShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3849ff18b8ccdd38_347_new)
...
HXLINE( 352)		this->uRadius->value = ::Array_obj< Float >::fromData( _hx_array_data_a0ce81ed_1,2);
HXLINE( 353)		this->uColor->value = ::Array_obj< Float >::fromData( _hx_array_data_a0ce81ed_2,4);

...
HX_DEFINE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_888_new,"lime._backend.native._NativeApplication.JoystickEventInfo","new",0x2df84fa1,"lime._backend.native._NativeApplication.JoystickEventInfo.new","lime/_backend/native/NativeApplication.hx",888,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_4c8f67ddac45293c_902_clone,"lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",902,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4c8f67ddac45293c_888_new)
HXLINE( 890)		this->type = type;
HXLINE( 891)		this->id = id;
HXLINE( 892)		this->index = index;
HXLINE( 893)		this->value = value;
HXLINE( 894)		this->x = x;
HXLINE( 895)		this->y = y;
            	}
...
bool JoystickEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_4c8f67ddac45293c_902_clone)
HXDLIN( 902)		return  ::lime::_backend::native::_NativeApplication::JoystickEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->index,this->value,this->x,this->y);
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_8961e926366f34cd_30_new,"EReg","new",0x8b859e81,"EReg.new","E:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",30,0xd357db27)
HX_LOCAL_STACK_FRAME(_hx_pos_8961e926366f34cd_38_match,"EReg","match",0x18fda1a6,"EReg.match","E:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",38,0xd357db27)
HX_LOCAL_STACK_FRAME(_hx_pos_8961e926366f34cd_47_matched,"EReg","matched",0x8ce62f85,"EReg.matched","E:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",47,0xd357db27)
HX_LOCAL_STACK_FRAME(_hx_pos_8961e926366f34cd_64_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","E:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",64,0xd357db27)
HX_LOCAL_STACK_FRAME(_hx_pos_8961e926366f34cd_67_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","E:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",67,0xd357db27)
HX_LOCAL_STACK_FRAME(_hx_pos_8961e926366f34cd_76_split,"EReg","split",0x9749433b,"EReg.split","E:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",76,0xd357db27)
HX_LOCAL_STACK_FRAME(_hx_pos_8961e926366f34cd_100_replace,"EReg","replace",0xae923ad5,"EReg.replace","E:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",100,0xd357db27)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8961e926366f34cd_151_map,"EReg","map",0x8b84d8bd,"EReg.map","E:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",151,0xd357db27)

void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_8961e926366f34cd_30_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_8961e926366f34cd_38_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_8961e926366f34cd_47_matched)
...
HX_DEFINE_DYNAMIC_FUNC1(EReg_obj,matched,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_8961e926366f34cd_64_matchedPos)
...
int len = __o_len.Default(-1);
            	HX_STACKFRAME(&_hx_pos_8961e926366f34cd_67_matchSub)
HXLINE(  68)		int p;
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_8961e926366f34cd_76_split)
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_8961e926366f34cd_100_replace)
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_8961e926366f34cd_151_map)

...
HX_DEFINE_STACK_FRAME(_hx_pos_acfc3034c2fca827_269_new,"_List.ListIterator","new",0x1ee472af,"_List.ListIterator.new","E:\\HaxeToolkit\\haxe\\std/List.hx",269,0x668981c9)
HX_LOCAL_STACK_FRAME(_hx_pos_acfc3034c2fca827_273_hasNext,"_List.ListIterator","hasNext",0x25781b3c,"_List.ListIterator.hasNext","E:\\HaxeToolkit\\haxe\\std/List.hx",273,0x668981c9)
HX_LOCAL_STACK_FRAME(_hx_pos_acfc3034c2fca827_276_next,"_List.ListIterator","next",0xe8ffe7c4,"_List.ListIterator.next","E:\\HaxeToolkit\\haxe\\std/List.hx",276,0x668981c9)
namespace _List{

void ListIterator_obj::__construct( ::_List::ListNode head){
            	HX_STACKFRAME(&_hx_pos_acfc3034c2fca827_269_new)
...
bool ListIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_acfc3034c2fca827_273_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ListIterator_obj,hasNext,return )
 ...
 ::Dynamic ListIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_acfc3034c2fca827_276_next)

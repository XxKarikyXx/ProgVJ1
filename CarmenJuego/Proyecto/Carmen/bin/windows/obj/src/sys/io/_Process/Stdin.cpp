...
HX_DEFINE_STACK_FRAME(_hx_pos_58286407e4c7e340_31_new,"sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",31,0x4b9e5bee)
HX_LOCAL_STACK_FRAME(_hx_pos_58286407e4c7e340_36_close,"sys.io._Process.Stdin","close",0xbd3fe37b,"sys.io._Process.Stdin.close","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",36,0x4b9e5bee)
HX_LOCAL_STACK_FRAME(_hx_pos_58286407e4c7e340_41_writeByte,"sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",41,0x4b9e5bee)
HX_LOCAL_STACK_FRAME(_hx_pos_58286407e4c7e340_47_writeBytes,"sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",47,0x4b9e5bee)
namespace sys{
namespace io{
namespace _Process{

void Stdin_obj::__construct( ::Dynamic p){
            	HX_STACKFRAME(&_hx_pos_58286407e4c7e340_31_new)
HXLINE(  32)		this->p = p;
...
void Stdin_obj::close(){
            	HX_STACKFRAME(&_hx_pos_58286407e4c7e340_36_close)
...
void Stdin_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_58286407e4c7e340_41_writeByte)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_58286407e4c7e340_47_writeBytes)
HXDLIN(  47)		try {

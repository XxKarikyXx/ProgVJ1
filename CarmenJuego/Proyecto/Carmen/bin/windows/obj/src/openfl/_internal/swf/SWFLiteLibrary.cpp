...
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_303___copyChannel,"openfl._internal.swf.SWFLiteLibrary","__copyChannel",0x00518107,"openfl._internal.swf.SWFLiteLibrary.__copyChannel","openfl/_internal/swf/SWFLiteLibrary.hx",303,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_320___fromManifest,"openfl._internal.swf.SWFLiteLibrary","__fromManifest",0x5078dda0,"openfl._internal.swf.SWFLiteLibrary.__fromManifest","openfl/_internal/swf/SWFLiteLibrary.hx",320,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_330___load,"openfl._internal.swf.SWFLiteLibrary","__load",0xd12f618d,"openfl._internal.swf.SWFLiteLibrary.__load","openfl/_internal/swf/SWFLiteLibrary.hx",330,0xbec32034)
HX_LOCAL_STACK_FRAME(_hx_pos_f3ab34383ae5e3ff_337___loadImage,"openfl._internal.swf.SWFLiteLibrary","__loadImage",0xd3596e8e,"openfl._internal.swf.SWFLiteLibrary.__loadImage","openfl/_internal/swf/SWFLiteLibrary.hx",337,0xbec32034)
namespace openfl{
namespace _internal{
namespace swf{
...
HXLINE( 285)		if (hx::IsNull( this->swf )) {
HXLINE( 285)			return;
            		}
HXLINE( 287)		 ::openfl::_internal::symbols::BitmapSymbol bitmap;
HXLINE( 289)		{
HXLINE( 289)			 ::Dynamic symbol = this->swf->symbols->iterator();
HXDLIN( 289)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 289)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 291)				if (::Std_obj::is(symbol1,hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >())) {
HXLINE( 293)					bitmap = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
HXLINE( 294)					::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,bitmap->path);
            				}
            			}
            		}
            	}
...
void SWFLiteLibrary_obj::_hx___copyChannel( ::lime::graphics::Image image, ::lime::graphics::Image alpha){
            	HX_GC_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_303___copyChannel)
HXLINE( 305)		if (hx::IsNotNull( alpha )) {
HXLINE( 307)			 ::lime::math::Rectangle _hx_tmp = alpha->get_rect();
HXDLIN( 307)			image->copyChannel(alpha,_hx_tmp, ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null()),::lime::graphics::ImageChannel_obj::RED_dyn(),::lime::graphics::ImageChannel_obj::ALPHA_dyn());
            		}
HXLINE( 311)		image->buffer->premultiplied = true;
            	}
...
void SWFLiteLibrary_obj::_hx___fromManifest( ::lime::utils::AssetManifest manifest){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_320___fromManifest)
HXLINE( 322)		this->rootPath = manifest->rootPath;
HXLINE( 323)		this->super::_hx___fromManifest(manifest);
            	}


 ::lime::app::Future SWFLiteLibrary_obj::_hx___load(){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_330___load)
HXDLIN( 330)		return this->super::load();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SWFLiteLibrary_obj,_hx___load,return )
 ...
 ::lime::app::Future SWFLiteLibrary_obj::_hx___loadImage(::String id){
            	HX_STACKFRAME(&_hx_pos_f3ab34383ae5e3ff_337___loadImage)
HXDLIN( 337)		return this->super::loadImage(id);
            	}

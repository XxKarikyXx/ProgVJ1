...
HX_DEFINE_STACK_FRAME(_hx_pos_b57e5ae6f1adf239_56_new,"haxe.format.JsonPrinter","new",0xeb68de75,"haxe.format.JsonPrinter.new","E:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",56,0x97ce6d92)
HX_LOCAL_STACK_FRAME(_hx_pos_b57e5ae6f1adf239_79_write,"haxe.format.JsonPrinter","write",0x755dea34,"haxe.format.JsonPrinter.write","E:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",79,0x97ce6d92)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b57e5ae6f1adf239_167_fieldsString,"haxe.format.JsonPrinter","fieldsString",0x974bd375,"haxe.format.JsonPrinter.fieldsString","E:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",167,0x97ce6d92)
HX_LOCAL_STACK_FRAME(_hx_pos_b57e5ae6f1adf239_193_quote,"haxe.format.JsonPrinter","quote",0x02f6a091,"haxe.format.JsonPrinter.quote","E:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",193,0x97ce6d92)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b57e5ae6f1adf239_225_quoteUtf8,"haxe.format.JsonPrinter","quoteUtf8",0x88683e62,"haxe.format.JsonPrinter.quoteUtf8","E:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",225,0x97ce6d92)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b57e5ae6f1adf239_44_print,"haxe.format.JsonPrinter","print",0x6d8fd582,"haxe.format.JsonPrinter.print","E:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",44,0x97ce6d92)
namespace haxe{
namespace format{

void JsonPrinter_obj::__construct( ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_b57e5ae6f1adf239_56_new)
...
void JsonPrinter_obj::write( ::Dynamic k, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_b57e5ae6f1adf239_79_write)
...
void JsonPrinter_obj::fieldsString( ::Dynamic v,::Array< ::String > fields){
            	HX_STACKFRAME(&_hx_pos_b57e5ae6f1adf239_167_fieldsString)
HXLINE( 168)		{
...
void JsonPrinter_obj::quote(::String s){
            	HX_STACKFRAME(&_hx_pos_b57e5ae6f1adf239_193_quote)
...
void JsonPrinter_obj::quoteUtf8(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_b57e5ae6f1adf239_225_quoteUtf8)
...
::String JsonPrinter_obj::print( ::Dynamic o, ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_b57e5ae6f1adf239_44_print)

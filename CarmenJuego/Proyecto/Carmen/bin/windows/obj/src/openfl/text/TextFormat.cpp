...
HXDLIN(  88)		if (hx::IsNotNull( format->url )) {
HXLINE(  88)			_hx_tmp = (format->url != HX_("",00,00,00,00));
            		}
            		else {
HXLINE(  88)			_hx_tmp = false;
            		}
HXDLIN(  88)		if (_hx_tmp) {
HXLINE(  88)			this->url = format->url;
            		}
HXLINE(  89)		bool _hx_tmp1;
HXDLIN(  89)		if ((format->url == HX_("",00,00,00,00))) {
HXLINE(  89)			_hx_tmp1 = hx::IsNull( this->url );
            		}
            		else {
HXLINE(  89)			_hx_tmp1 = false;
            		}
HXDLIN(  89)		if (_hx_tmp1) {
HXLINE(  89)			this->url = HX_("",00,00,00,00);
            		}
HXLINE(  91)		if (hx::IsNotNull( format->target )) {
HXLINE(  91)			this->target = format->target;
            		}
HXLINE(  92)		if (hx::IsNotNull( format->align )) {
HXLINE(  92)			this->align = format->align;
            		}
HXLINE(  93)		if (hx::IsNotNull( format->leftMargin )) {
HXLINE(  93)			this->leftMargin = format->leftMargin;
            		}
HXLINE(  94)		if (hx::IsNotNull( format->rightMargin )) {
HXLINE(  94)			this->rightMargin = format->rightMargin;
            		}
HXLINE(  95)		if (hx::IsNotNull( format->indent )) {
HXLINE(  95)			this->indent = format->indent;
            		}
HXLINE(  96)		if (hx::IsNotNull( format->leading )) {
HXLINE(  96)			this->leading = format->leading;
            		}
HXLINE(  97)		if (hx::IsNotNull( format->blockIndent )) {
HXLINE(  97)			this->blockIndent = format->blockIndent;
            		}
HXLINE(  98)		if (hx::IsNotNull( format->bullet )) {
HXLINE(  98)			this->bullet = format->bullet;
            		}
HXLINE(  99)		if (hx::IsNotNull( format->kerning )) {
HXLINE(  99)			this->kerning = format->kerning;
            		}
HXLINE( 100)		if (hx::IsNotNull( format->letterSpacing )) {
HXLINE( 100)			this->letterSpacing = format->letterSpacing;
            		}
HXLINE( 101)		if (hx::IsNotNull( format->tabStops )) {
HXLINE( 101)			this->tabStops = format->tabStops;
            		}
HXLINE( 103)		if (hx::IsNotNull( format->_hx___ascent )) {
HXLINE( 103)			this->_hx___ascent = format->_hx___ascent;
            		}
HXLINE( 104)		if (hx::IsNotNull( format->_hx___descent )) {
HXLINE( 104)			this->_hx___descent = format->_hx___descent;
            		}
            	}

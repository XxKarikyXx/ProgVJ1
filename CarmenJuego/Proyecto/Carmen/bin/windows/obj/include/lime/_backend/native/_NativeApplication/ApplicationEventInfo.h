...
HX_DECLARE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_747_new)
...
HXLINE( 749)		( ( ::lime::_backend::native::_NativeApplication::ApplicationEventInfo)(__this) )->type = type;
HXLINE( 750)		( ( ::lime::_backend::native::_NativeApplication::ApplicationEventInfo)(__this) )->deltaTime = deltaTime;
            	}

...
HXLINE( 137)			{
HXLINE( 137)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile23 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::display::DisplayObject >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_36,8),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxRect >()));
...
HXLINE( 138)			{
HXLINE( 138)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile24 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::geom::Point >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
...
HXLINE( 139)			{
HXLINE( 139)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile25 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::geom::Rectangle >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxRect >()));
...
HXLINE( 140)			{
HXLINE( 140)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile26 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::geom::Matrix >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_37,6),null());

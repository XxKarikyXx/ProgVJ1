...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("TuMadre", "Carmen", "Carmen", "1.0.0");
		...
		telemetryConfig.app_name = "Carmen";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Carmen", null, { width: 1920, height: 1080 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1920, height: 1080 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 1920, 1080, "null");
		#end
		#else
		create ();
		#end

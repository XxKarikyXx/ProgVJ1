...
HX_LOCAL_STACK_FRAME(_hx_pos_f933a14112391a23_30_getContent,"sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",30,0xca065023)
HX_LOCAL_STACK_FRAME(_hx_pos_f933a14112391a23_55_write,"sys.io.File","write",0xfec8a9f4,"sys.io.File.write","E:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/File.hx",55,0xca065023)
namespace sys{
namespace io{
...
::String File_obj::getContent(::String path){
            	HX_STACKFRAME(&_hx_pos_f933a14112391a23_30_getContent)
...
bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_f933a14112391a23_55_write)

...
HX_DECLARE_STACK_FRAME(_hx_pos_c51b2e87fb75d55f_29_new)
...
HXLINE(  31)		( ( ::lime::ui::Touch)(__this) )->x = x;
HXLINE(  32)		( ( ::lime::ui::Touch)(__this) )->y = y;
HXLINE(  33)		( ( ::lime::ui::Touch)(__this) )->id = id;
HXLINE(  34)		( ( ::lime::ui::Touch)(__this) )->dx = dx;
HXLINE(  35)		( ( ::lime::ui::Touch)(__this) )->dy = dy;
HXLINE(  36)		( ( ::lime::ui::Touch)(__this) )->pressure = pressure;
HXLINE(  37)		( ( ::lime::ui::Touch)(__this) )->device = device;
            	}

...
HX_LOCAL_STACK_FRAME(_hx_pos_669fad39a85a1300_12__new,"lime.media.openal._ALFilter.ALFilter_Impl_","_new",0x0c9e894a,"lime.media.openal._ALFilter.ALFilter_Impl_._new","lime/media/openal/ALFilter.hx",12,0xe4e47d86)
namespace lime{
namespace media{
namespace openal{
namespace _ALFilter{
...
bool ALFilter_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ALFilter_Impl__obj::_new( ::Dynamic handle){
            	HX_STACKFRAME(&_hx_pos_669fad39a85a1300_12__new)

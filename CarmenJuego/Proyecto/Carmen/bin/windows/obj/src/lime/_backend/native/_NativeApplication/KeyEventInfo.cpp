...
HX_DEFINE_STACK_FRAME(_hx_pos_4be9d6956d8ea946_932_new,"lime._backend.native._NativeApplication.KeyEventInfo","new",0x9d1330f8,"lime._backend.native._NativeApplication.KeyEventInfo.new","lime/_backend/native/NativeApplication.hx",932,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_4be9d6956d8ea946_944_clone,"lime._backend.native._NativeApplication.KeyEventInfo","clone",0x1c2dc9f5,"lime._backend.native._NativeApplication.KeyEventInfo.clone","lime/_backend/native/NativeApplication.hx",944,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
HXLINE( 934)		this->type = type;
HXLINE( 935)		this->windowID = windowID;
HXLINE( 936)		this->keyCode = keyCode;
HXLINE( 937)		this->modifier = modifier;
            	}
...
bool KeyEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_4be9d6956d8ea946_944_clone)
HXDLIN( 944)		return  ::lime::_backend::native::_NativeApplication::KeyEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->keyCode,this->modifier);
            	}

...
class HXCPP_CLASS_ATTRIBUTES ThreadPool_obj : public hx::Object
{
	...
	public:
		...
		int currentThreads;
		 ::lime::app::_Event_haxe_Function_Void doWork;
		int maxThreads;
		int minThreads;
		 ::lime::app::_Event_haxe_Function_Void onComplete;
		 ::lime::app::_Event_haxe_Function_Void onError;
		 ::lime::app::_Event_haxe_Function_Void onProgress;
		 ::lime::app::_Event_haxe_Function_Void onRun;

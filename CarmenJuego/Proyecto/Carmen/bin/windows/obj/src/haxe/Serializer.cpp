...
HX_DEFINE_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_101_new,"haxe.Serializer","new",0xcdbbc7ec,"haxe.Serializer.new","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",101,0xeff6da3a)
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_117_toString,"haxe.Serializer","toString",0x95bdfda0,"haxe.Serializer.toString","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",117,0xeff6da3a)
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_153_serializeString,"haxe.Serializer","serializeString",0xd565bc5d,"haxe.Serializer.serializeString","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",153,0xeff6da3a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_172_serializeRef,"haxe.Serializer","serializeRef",0x0b8ed647,"haxe.Serializer.serializeRef","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",172,0xeff6da3a)
static const ::String _hx_array_data_6a6ea1fa_8[] = {
	HX_("r",72,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_209_serializeFields,"haxe.Serializer","serializeFields",0x44c42205,"haxe.Serializer.serializeFields","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",209,0xeff6da3a)
static const ::String _hx_array_data_6a6ea1fa_11[] = {
	HX_("g",67,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_228_serialize,"haxe.Serializer","serialize",0x3cea866c,"haxe.Serializer.serialize","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",228,0xeff6da3a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_556_run,"haxe.Serializer","run",0xcdbeded7,"haxe.Serializer.run","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",556,0xeff6da3a)
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_55_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",55,0xeff6da3a)
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_67_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",67,0xeff6da3a)
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_69_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",69,0xeff6da3a)
HX_LOCAL_STACK_FRAME(_hx_pos_5e7e1dd0fdfb5a39_70_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","E:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",70,0xeff6da3a)
namespace haxe{

void Serializer_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_101_new)
...
::String Serializer_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_117_toString)
...
void Serializer_obj::serializeString(::String s){
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_153_serializeString)
...
bool Serializer_obj::serializeRef( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_172_serializeRef)
HXLINE( 176)		{
...
void Serializer_obj::serializeFields( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_209_serializeFields)
HXLINE( 210)		{
...
void Serializer_obj::serialize( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_228_serialize)
...
::String Serializer_obj::run( ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_556_run)
...
{
{
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_55_boot)
HXDLIN(  55)		USE_CACHE = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_67_boot)
HXDLIN(  67)		USE_ENUM_INDEX = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_69_boot)
HXDLIN(  69)		BASE64 = HX_("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%:",d4,3b,03,7f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5e7e1dd0fdfb5a39_70_boot)

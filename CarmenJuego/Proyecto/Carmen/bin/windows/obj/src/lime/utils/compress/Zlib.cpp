...
HX_LOCAL_STACK_FRAME(_hx_pos_b7ae7edfe2bcbf35_67_decompress,"lime.utils.compress.Zlib","decompress",0xe6dcf2d0,"lime.utils.compress.Zlib.decompress","lime/utils/compress/Zlib.hx",67,0xe800dd9e)
namespace lime{
namespace utils{
namespace compress{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Zlib_obj,compress,return )
 ...
 ::haxe::io::Bytes Zlib_obj::decompress( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_b7ae7edfe2bcbf35_67_decompress)
HXDLIN(  67)		 ::Dynamic bytes1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  67)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_zlib_decompress(hx::DynamicPtr(bytes),hx::DynamicPtr(bytes1))) );
            	}

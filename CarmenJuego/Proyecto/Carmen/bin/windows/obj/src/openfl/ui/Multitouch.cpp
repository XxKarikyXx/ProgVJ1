...
HX_LOCAL_STACK_FRAME(_hx_pos_d04537844d94f90f_22___init__,"::openfl::ui::Multitouch_obj","__init__",0xd9e1825c,"::openfl::ui::Multitouch_obj.__init__","openfl/ui/Multitouch.hx",22,0xce42901c)
HX_LOCAL_STACK_FRAME(_hx_pos_0f8b8e224a678ffc_59_get_supportsTouchEvents,"openfl.ui.Multitouch","get_supportsTouchEvents",0x2ba8207f,"openfl.ui.Multitouch.get_supportsTouchEvents","openfl/ui/Multitouch.hx",59,0xce42901c)
namespace openfl{
namespace ui{
...
void Multitouch_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_d04537844d94f90f_22___init__)
HXLINE(  24)		::openfl::ui::Multitouch_obj::maxTouchPoints = (int)2;
HXLINE(  25)		::openfl::ui::Multitouch_obj::supportedGestures = null();
HXLINE(  26)		::openfl::ui::Multitouch_obj::supportsGestureEvents = false;
HXLINE(  27)		::openfl::ui::Multitouch_obj::inputMode = (int)2;
            	}
...
bool Multitouch_obj::get_supportsTouchEvents(){
            	HX_STACKFRAME(&_hx_pos_0f8b8e224a678ffc_59_get_supportsTouchEvents)

...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("img/PowerUp/powerUpPlaceholder.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/PowerUp/powerUpPlaceholder.png", Reflect.field (AssetType, "image".toUpperCase ()));

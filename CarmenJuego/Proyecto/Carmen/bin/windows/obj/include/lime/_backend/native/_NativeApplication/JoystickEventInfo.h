...
HX_DECLARE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_888_new)
...
HXLINE( 890)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->type = type;
HXLINE( 891)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->id = id;
HXLINE( 892)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->index = index;
HXLINE( 893)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->value = value;
HXLINE( 894)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->x = x;
HXLINE( 895)		( ( ::lime::_backend::native::_NativeApplication::JoystickEventInfo)(__this) )->y = y;
            	}

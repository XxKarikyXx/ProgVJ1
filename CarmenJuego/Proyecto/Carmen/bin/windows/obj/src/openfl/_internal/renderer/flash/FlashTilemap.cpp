...
HX_LOCAL_STACK_FRAME(_hx_pos_902fc7ae56fcb148_30_render,"openfl._internal.renderer.flash.FlashTilemap","render",0xa68b48cd,"openfl._internal.renderer.flash.FlashTilemap.render","openfl/_internal/renderer/flash/FlashTilemap.hx",30,0x8554e347)
HX_LOCAL_STACK_FRAME(_hx_pos_902fc7ae56fcb148_50_renderTileContainer,"openfl._internal.renderer.flash.FlashTilemap","renderTileContainer",0xf9fd7f26,"openfl._internal.renderer.flash.FlashTilemap.renderTileContainer","openfl/_internal/renderer/flash/FlashTilemap.hx",50,0x8554e347)
HX_LOCAL_STACK_FRAME(_hx_pos_902fc7ae56fcb148_24_boot,"openfl._internal.renderer.flash.FlashTilemap","boot",0x2e8045e9,"openfl._internal.renderer.flash.FlashTilemap.boot","openfl/_internal/renderer/flash/FlashTilemap.hx",24,0x8554e347)
...
void FlashTilemap_obj::render( ::openfl::display::Tilemap tilemap){
            	HX_STACKFRAME(&_hx_pos_902fc7ae56fcb148_30_render)
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlashTilemap_obj,render,(void))

void FlashTilemap_obj::renderTileContainer( ::openfl::display::TileContainer group, ::openfl::display::BitmapData bitmapData, ::openfl::geom::Matrix parentTransform, ::openfl::display::Tileset defaultTileset,bool smooth,bool alphaEnabled,Float worldAlpha,bool colorTransformEnabled, ::openfl::geom::ColorTransform defaultColorTransform, ::openfl::display::BitmapData cacheBitmapData){
            	HX_STACKFRAME(&_hx_pos_902fc7ae56fcb148_50_renderTileContainer)
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC10(FlashTilemap_obj,renderTileContainer,(void))
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_902fc7ae56fcb148_24_boot)
HXDLIN(  24)		alphaColorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_902fc7ae56fcb148_25_boot)
HXDLIN(  25)		bitmap =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,null(),null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_902fc7ae56fcb148_26_boot)
HXDLIN(  26)		destPoint =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_902fc7ae56fcb148_27_boot)
HXDLIN(  27)		sourceRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            	}
}

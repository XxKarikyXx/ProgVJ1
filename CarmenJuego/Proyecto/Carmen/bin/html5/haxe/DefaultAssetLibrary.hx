...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("img/PowerUp/powerUpPlaceholder.png", __ASSET__img_powerup_powerupplaceholder_png);
		...
		className.set ("assets/img/PowerUp/powerUpPlaceholder.png", __ASSET__assets_img_powerup_powerupplaceholder_png);
...
@:keep @:bind #if display private #end class __ASSET__img_powerup_powerupplaceholder_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_img_powerup_powerupplaceholder_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("E:/Apps/HaxeToolkit/haxe/lib/flixel/4,2,1/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.Bytes {}
@:file("E:/Apps/HaxeToolkit/haxe/lib/flixel/4,2,1/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.Bytes {}
...
@:image("assets/img/PowerUp/powerUpPlaceholder.png") #if display private #end class __ASSET__img_powerup_powerupplaceholder_png extends lime.graphics.Image {}
...
@:image("assets/img/PowerUp/powerUpPlaceholder.png") #if display private #end class __ASSET__assets_img_powerup_powerupplaceholder_png extends lime.graphics.Image {}

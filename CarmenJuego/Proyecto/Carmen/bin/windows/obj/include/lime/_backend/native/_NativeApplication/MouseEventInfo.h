...
HX_DECLARE_STACK_FRAME(_hx_pos_e3566ee739d748b6_973_new)
...
HXLINE( 975)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->type = type;
HXLINE( 976)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->windowID = (int)0;
HXLINE( 977)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->x = x;
HXLINE( 978)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->y = y;
HXLINE( 979)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->button = button;
HXLINE( 980)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->movementX = movementX;
HXLINE( 981)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->movementY = movementY;
            	}

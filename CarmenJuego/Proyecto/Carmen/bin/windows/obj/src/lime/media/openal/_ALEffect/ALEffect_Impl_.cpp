...
HX_LOCAL_STACK_FRAME(_hx_pos_4ccb4f4d746e2239_12__new,"lime.media.openal._ALEffect.ALEffect_Impl_","_new",0x9bfb986a,"lime.media.openal._ALEffect.ALEffect_Impl_._new","lime/media/openal/ALEffect.hx",12,0x4805d04d)
namespace lime{
namespace media{
namespace openal{
namespace _ALEffect{
...
bool ALEffect_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ALEffect_Impl__obj::_new( ::Dynamic handle){
            	HX_STACKFRAME(&_hx_pos_4ccb4f4d746e2239_12__new)

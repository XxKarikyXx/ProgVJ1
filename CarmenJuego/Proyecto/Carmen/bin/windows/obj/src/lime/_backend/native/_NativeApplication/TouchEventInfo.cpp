...
HX_DEFINE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1131_new,"lime._backend.native._NativeApplication.TouchEventInfo","new",0x974ae818,"lime._backend.native._NativeApplication.TouchEventInfo.new","lime/_backend/native/NativeApplication.hx",1131,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1147_clone,"lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1147,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int device = __o_device.Default(0);
            	HX_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1131_new)
HXLINE(1133)		this->type = type;
HXLINE(1134)		this->x = x;
HXLINE(1135)		this->y = y;
HXLINE(1136)		this->id = id;
HXLINE(1137)		this->dx = dx;
HXLINE(1138)		this->dy = dy;
HXLINE(1139)		this->pressure = pressure;
HXLINE(1140)		this->device = device;
            	}
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1147_clone)
HXDLIN(1147)		return  ::lime::_backend::native::_NativeApplication::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}

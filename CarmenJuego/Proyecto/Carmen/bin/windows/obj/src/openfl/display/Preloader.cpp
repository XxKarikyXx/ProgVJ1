...
HXLINE(  36)			::openfl::Lib_obj::get_current()->addChild(display);
            		}
            	}
...
HXLINE(  50)		::openfl::Lib_obj::get_current()->get_loaderInfo()->_hx___complete();
...
HXLINE(  76)		::openfl::Lib_obj::get_current()->get_loaderInfo()->_hx___update(loaded,total);
...
HXLINE( 101)			 ::openfl::display::DisplayObjectContainer _hx_tmp = this->display->parent;
HXDLIN( 101)			if (hx::IsEq( _hx_tmp,::openfl::Lib_obj::get_current() )) {
HXLINE( 103)				::openfl::Lib_obj::get_current()->removeChild(this->display);
            			}
HXLINE( 107)			::openfl::Lib_obj::get_current()->stage->set_focus(null());
HXLINE( 108)			this->display = null();
            		}
HXLINE( 112)		bool _hx_tmp1;
HXDLIN( 112)		if (this->ready) {
HXLINE( 112)			_hx_tmp1 = !(this->simulateProgress);
            		}
            		else {

...
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_180_gt,"lime.utils._Log.LogLevel_Impl_","gt",0x45da0308,"lime.utils._Log.LogLevel_Impl_.gt","lime/utils/Log.hx",180,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_181_gte,"lime.utils._Log.LogLevel_Impl_","gte",0xd8e8a45d,"lime.utils._Log.LogLevel_Impl_.gte","lime/utils/Log.hx",181,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_182_lt,"lime.utils._Log.LogLevel_Impl_","lt",0x45da0763,"lime.utils._Log.LogLevel_Impl_.lt","lime/utils/Log.hx",182,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_183_lte,"lime.utils._Log.LogLevel_Impl_","lte",0xd8ec6fa2,"lime.utils._Log.LogLevel_Impl_.lte","lime/utils/Log.hx",183,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_173_boot,"lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",173,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_174_boot,"lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",174,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_175_boot,"lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",175,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_176_boot,"lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",176,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_177_boot,"lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",177,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_7301aa71ca1f1265_178_boot,"lime.utils._Log.LogLevel_Impl_","boot",0xef5559cd,"lime.utils._Log.LogLevel_Impl_.boot","lime/utils/Log.hx",178,0x300eb2b2)
namespace lime{
namespace utils{
namespace _Log{
...
bool LogLevel_Impl__obj::gt(int a,int b){
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_180_gt)
HXDLIN( 180)		return (a > b);
            	}
...
bool LogLevel_Impl__obj::gte(int a,int b){
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_181_gte)
...
bool LogLevel_Impl__obj::lt(int a,int b){
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_182_lt)
...
bool LogLevel_Impl__obj::lte(int a,int b){
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_183_lte)
HXDLIN( 183)		return (a <= b);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_173_boot)
HXDLIN( 173)		NONE = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_174_boot)
HXDLIN( 174)		ERROR = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_175_boot)
HXDLIN( 175)		WARN = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_176_boot)
HXDLIN( 176)		INFO = (int)3;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_177_boot)
HXDLIN( 177)		DEBUG = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_7301aa71ca1f1265_178_boot)
HXDLIN( 178)		VERBOSE = (int)5;
            	}
}

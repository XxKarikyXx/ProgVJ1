...
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_112_get_blurX,"openfl.filters.BlurFilter","get_blurX",0xeb11be0a,"openfl.filters.BlurFilter.get_blurX","openfl/filters/BlurFilter.hx",112,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_117_set_blurX,"openfl.filters.BlurFilter","set_blurX",0xce62aa16,"openfl.filters.BlurFilter.set_blurX","openfl/filters/BlurFilter.hx",117,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_132_get_blurY,"openfl.filters.BlurFilter","get_blurY",0xeb11be0b,"openfl.filters.BlurFilter.get_blurY","openfl/filters/BlurFilter.hx",132,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_137_set_blurY,"openfl.filters.BlurFilter","set_blurY",0xce62aa17,"openfl.filters.BlurFilter.set_blurY","openfl/filters/BlurFilter.hx",137,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_152_get_quality,"openfl.filters.BlurFilter","get_quality",0xa28f7338,"openfl.filters.BlurFilter.get_quality","openfl/filters/BlurFilter.hx",152,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_157_set_quality,"openfl.filters.BlurFilter","set_quality",0xacfc7a44,"openfl.filters.BlurFilter.set_quality","openfl/filters/BlurFilter.hx",157,0x46563eac)
...
HXLINE(  84)		if ((pass <= this->_hx___horizontalPasses)) {
HXLINE(  86)			Float scale = ::Math_obj::pow(((Float)0.5),((int)pass >> (int)(int)1));
HXLINE(  87)			::Array< Float > _hx_tmp = ::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value;
HXDLIN(  87)			_hx_tmp[(int)0] = (this->get_blurX() * scale);
HXLINE(  88)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[(int)1] = (int)0;
            		}
            		else {
HXLINE(  92)			Float scale1 = ::Math_obj::pow(((Float)0.5),((int)(pass - this->_hx___horizontalPasses) >> (int)(int)1));
HXLINE(  93)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[(int)0] = (int)0;
HXLINE(  94)			::Array< Float > _hx_tmp1 = ::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value;
HXDLIN(  94)			_hx_tmp1[(int)1] = (this->get_blurY() * scale1);
            		}
HXLINE(  98)		return ::openfl::filters::BlurFilter_obj::_hx___blurShader;
            	}


Float BlurFilter_obj::get_blurX(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_112_get_blurX)
HXDLIN( 112)		return this->_hx___blurX;
            	}
...
Float BlurFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_117_set_blurX)
HXLINE( 119)		if ((value != this->_hx___blurX)) {
HXLINE( 120)			this->_hx___blurX = value;
HXLINE( 121)			this->_hx___renderDirty = true;
HXLINE( 122)			int _hx_tmp;
HXDLIN( 122)			if ((value > (int)0)) {
HXLINE( 122)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 122)				_hx_tmp = (int)0;
            			}
HXDLIN( 122)			this->_hx___leftExtension = _hx_tmp;
HXLINE( 123)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
Float BlurFilter_obj::get_blurY(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_132_get_blurY)
HXDLIN( 132)		return this->_hx___blurY;
            	}
...
Float BlurFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_137_set_blurY)
HXLINE( 139)		if ((value != this->_hx___blurY)) {
HXLINE( 140)			this->_hx___blurY = value;
HXLINE( 141)			this->_hx___renderDirty = true;
HXLINE( 142)			int _hx_tmp;
HXDLIN( 142)			if ((value > (int)0)) {
HXLINE( 142)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 142)				_hx_tmp = (int)0;
            			}
HXDLIN( 142)			this->_hx___topExtension = _hx_tmp;
HXLINE( 143)			this->_hx___bottomExtension = this->_hx___topExtension;
            		}
...
int BlurFilter_obj::get_quality(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_152_get_quality)
HXDLIN( 152)		return this->_hx___quality;
            	}
...
int BlurFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_157_set_quality)
HXLINE( 161)		int _hx_tmp;
HXDLIN( 161)		if ((this->_hx___blurX <= (int)0)) {
HXLINE( 161)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 161)			Float _hx_tmp1 = this->_hx___blurX;
HXDLIN( 161)			_hx_tmp = (::Math_obj::round((_hx_tmp1 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 161)		this->_hx___horizontalPasses = _hx_tmp;
HXLINE( 162)		int _hx_tmp2;
HXDLIN( 162)		if ((this->_hx___blurY <= (int)0)) {
HXLINE( 162)			_hx_tmp2 = (int)0;
            		}
            		else {
HXLINE( 162)			Float _hx_tmp3 = this->_hx___blurY;
HXDLIN( 162)			_hx_tmp2 = (::Math_obj::round((_hx_tmp3 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 162)		this->_hx___verticalPasses = _hx_tmp2;
HXLINE( 164)		this->_hx___numShaderPasses = (this->_hx___horizontalPasses + this->_hx___verticalPasses);
HXLINE( 166)		if ((value != this->_hx___quality)) {
HXLINE( 166)			this->_hx___renderDirty = true;
            		}
HXLINE( 167)		return (this->_hx___quality = value);
            	}

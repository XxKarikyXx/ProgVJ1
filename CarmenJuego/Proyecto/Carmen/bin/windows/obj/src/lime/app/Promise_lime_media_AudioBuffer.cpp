...
HX_DEFINE_STACK_FRAME(_hx_pos_dc587d2dc6aca49f_36_new,"lime.app.Promise_lime_media_AudioBuffer","new",0xd173472d,"lime.app.Promise_lime_media_AudioBuffer.new","lime/app/Promise.hx",36,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_dc587d2dc6aca49f_41_complete,"lime.app.Promise_lime_media_AudioBuffer","complete",0x5205c2cc,"lime.app.Promise_lime_media_AudioBuffer.complete","lime/app/Promise.hx",41,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_dc587d2dc6aca49f_67_completeWith,"lime.app.Promise_lime_media_AudioBuffer","completeWith",0xa49ebaf2,"lime.app.Promise_lime_media_AudioBuffer.completeWith","lime/app/Promise.hx",67,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_dc587d2dc6aca49f_79_error,"lime.app.Promise_lime_media_AudioBuffer","error",0x642e4fd5,"lime.app.Promise_lime_media_AudioBuffer.error","lime/app/Promise.hx",79,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_dc587d2dc6aca49f_105_progress,"lime.app.Promise_lime_media_AudioBuffer","progress",0x5868b9c0,"lime.app.Promise_lime_media_AudioBuffer.progress","lime/app/Promise.hx",105,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_dc587d2dc6aca49f_135_get_isComplete,"lime.app.Promise_lime_media_AudioBuffer","get_isComplete",0x687fad5f,"lime.app.Promise_lime_media_AudioBuffer.get_isComplete","lime/app/Promise.hx",135,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_dc587d2dc6aca49f_142_get_isError,"lime.app.Promise_lime_media_AudioBuffer","get_isError",0x4f805b62,"lime.app.Promise_lime_media_AudioBuffer.get_isError","lime/app/Promise.hx",142,0x10ba4f0b)
namespace lime{
namespace app{

void Promise_lime_media_AudioBuffer_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_dc587d2dc6aca49f_36_new)
...
bool Promise_lime_media_AudioBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::app::Promise_lime_media_AudioBuffer Promise_lime_media_AudioBuffer_obj::complete( ::lime::media::AudioBuffer data){
            	HX_STACKFRAME(&_hx_pos_dc587d2dc6aca49f_41_complete)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_media_AudioBuffer_obj,complete,return )
 ...
 ::lime::app::Promise_lime_media_AudioBuffer Promise_lime_media_AudioBuffer_obj::completeWith( ::lime::app::Future future){
            	HX_STACKFRAME(&_hx_pos_dc587d2dc6aca49f_67_completeWith)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_media_AudioBuffer_obj,completeWith,return )
 ...
 ::lime::app::Promise_lime_media_AudioBuffer Promise_lime_media_AudioBuffer_obj::error( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_dc587d2dc6aca49f_79_error)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_media_AudioBuffer_obj,error,return )
 ...
 ::lime::app::Promise_lime_media_AudioBuffer Promise_lime_media_AudioBuffer_obj::progress(int progress,int total){
            	HX_STACKFRAME(&_hx_pos_dc587d2dc6aca49f_105_progress)
...
bool Promise_lime_media_AudioBuffer_obj::get_isComplete(){
            	HX_STACKFRAME(&_hx_pos_dc587d2dc6aca49f_135_get_isComplete)
...
bool Promise_lime_media_AudioBuffer_obj::get_isError(){
            	HX_STACKFRAME(&_hx_pos_dc587d2dc6aca49f_142_get_isError)

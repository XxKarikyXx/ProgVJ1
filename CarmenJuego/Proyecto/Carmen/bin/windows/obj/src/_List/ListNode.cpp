...
HX_DEFINE_STACK_FRAME(_hx_pos_3aa728d85c8859f1_255_new,"_List.ListNode","new",0x20597943,"_List.ListNode.new","E:\\HaxeToolkit\\haxe\\std/List.hx",255,0x668981c9)
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_3aa728d85c8859f1_255_new)

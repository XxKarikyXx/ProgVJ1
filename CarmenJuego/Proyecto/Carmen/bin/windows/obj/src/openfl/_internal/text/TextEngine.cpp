...
HXLINE(1252)					{
HXLINE(1252)						if ((rangeIndex < (( (int)(_gthis->textFormatRanges->__Field(HX_("get_length",af,04,8f,8f),hx::paccDynamic)()) ) - (int)1))) {
...
HXLINE(1493)							{
HXLINE(1493)								if ((rangeIndex < (( (int)(_gthis->textFormatRanges->__Field(HX_("get_length",af,04,8f,8f),hx::paccDynamic)()) ) - (int)1))) {
...
HXLINE(1563)					{
HXLINE(1563)						if ((rangeIndex < (( (int)(_gthis->textFormatRanges->__Field(HX_("get_length",af,04,8f,8f),hx::paccDynamic)()) ) - (int)1))) {
...
HXDLIN(1659)									int _g21 = ( (int)(this->layoutGroups->__Field(HX_("get_length",af,04,8f,8f),hx::paccDynamic)()) );

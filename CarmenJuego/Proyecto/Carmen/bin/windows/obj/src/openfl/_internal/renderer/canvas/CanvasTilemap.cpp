...
HX_LOCAL_STACK_FRAME(_hx_pos_e7071a4c3b179226_26_render,"openfl._internal.renderer.canvas.CanvasTilemap","render",0x42cdc289,"openfl._internal.renderer.canvas.CanvasTilemap.render","openfl/_internal/renderer/canvas/CanvasTilemap.hx",26,0xd031c225)
...
void CanvasTilemap_obj::render( ::openfl::display::Tilemap tilemap, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_e7071a4c3b179226_26_render)
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(CanvasTilemap_obj,render,(void))

void CanvasTilemap_obj::renderTileContainer( ::openfl::display::TileContainer group, ::openfl::display::CanvasRenderer renderer, ::openfl::geom::Matrix parentTransform, ::openfl::display::Tileset defaultTileset,bool smooth,bool alphaEnabled,Float worldAlpha, ::openfl::display::BitmapData cacheBitmapData, ::Dynamic source, ::openfl::geom::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_e7071a4c3b179226_69_renderTileContainer)
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC10(CanvasTilemap_obj,renderTileContainer,(void))
